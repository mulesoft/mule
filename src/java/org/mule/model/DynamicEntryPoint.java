...
/**
 * <code>DynamicEntryPoint</code> is used to detemine the entry point on a bean after
 * an event has been received for it.  The entrypoint is then discovered using the event
 * payload type as the argument.
 * An entry point will try and be matched for different argument types so it's possible to have
...
public class DynamicEntryPoint implements UMOEntryPoint
{
    ...
    public Object invoke(Object component, UMOEventContext context, Method method) throws InvocationTargetException, IllegalAccessException, TransformerException
    {
        Object payload = null;
        if (method == null)
        {
    ...
    private Object invokeCurrent(Object component, Object arg) throws InvocationTargetException, IllegalAccessException
    {
        ...
        if (logger.isDebugEnabled())
        {
            methodCall = component.getClass().getName() + "." + currentMethod.getName() + "(" + arg.getClass().getName() + ")";
