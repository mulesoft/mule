...
public class PoolingProfile
{
     ...
     * You can specify this value on the descriptor declaration. If none is set this value
     * will be used.  If this value is not set then a system default of '5' will be used.
     */
    public static final int DEFAULT_MAX_POOL_IDLE = ObjectPool.DEFAULT_MAX_SIZE;

    /**
     * When the threadPoolExhaustedAction is setto 2 (WHEN_EXHAUSTED_BLOCK) this can specify the
     ...
     * <ul>
     * <li>0 (POOL_INIT_NO_COMPONENTs) : Will not load any components in the pool on startup</li>
     * <li>1 (POOL_INIT_ONE_COMPONENT) : Will load only the first component in the pool on startup</li>
     ...
     *         when the pool of Mule UMOs is exhausted and the PoolExhaustedAction is set to
