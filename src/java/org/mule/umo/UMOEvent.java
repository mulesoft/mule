 ...
 * <p/>
 * <p/>
 * The UMOEvent holds a UMOMessage payload and provides helper methods for obtaining the
 * data in a format that the receiving Mule UMO understands. The event can also
 * maintain any number of properties that can be set and retrieved by Mule UMO
 * components.
 * @see UMOMessage
 *
...
public interface UMOEvent
{
    ...
    /**
     * The number of milliseconds to wait for a return event when
     * running synchronously.
     * 0  wait forever
     * -1 try and receive, but do not wait
     * or a positive millisecod value
