...
/**
 * <code>UMOInterceptor</code> is based on a similar concept of servlet filters and works much the
...
public interface UMOInterceptor
{
     ...
     * @param invocation the invocation containing info about the current message and component
