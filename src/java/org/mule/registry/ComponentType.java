...
public class ComponentType {
    ...
    public static final ComponentType[] COMPONENT_TYPES = new ComponentType[]{
        MULE_COMPONENT, MULE_COMPONENT, MULE_TRANSFORMER_COMPONENT, MULE_AGENT_COMPONENT, JBI_ENGINE_COMPONENT, JBI_BINDING_COMPONENT};
    ...
    public boolean equals(Object o) {
        ...
        if (name != null ? !name.equals(componentType.name) : componentType.name != null) return false;
