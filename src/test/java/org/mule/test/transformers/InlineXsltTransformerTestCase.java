 ...
 * $Header$
 * $Revision: 1983 $
 * $Date: 2006-04-29 18:35:25 +0200 (lÃ¸, 29 apr 2006) $
 * ------------------------------------------------------------------------------------------------------
 *
...
public class InlineXsltTransformerTestCase extends AbstractXmlTransformerTestCase
{
    ...
    {
        srcData = Utility.loadResourceAsString("simple.xml", getClass());
        resultData = Utility.loadResourceAsString("simple-out.xml", getClass());
    }
