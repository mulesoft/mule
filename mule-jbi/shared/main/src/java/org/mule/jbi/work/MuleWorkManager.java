...
import org.mule.jbi.work.pool.NullWorkExecutorPool;
import org.mule.jbi.work.pool.ScheduleWorkExecutor;
import org.mule.jbi.work.pool.StartWorkExecutor;
import org.mule.jbi.work.pool.SyncWorkExecutor;
import org.mule.jbi.work.pool.WorkExecutor;
import org.mule.jbi.work.pool.WorkExecutorPool;
...
public class MuleWorkManager implements WorkManager
{
    ...
    public MuleWorkManager(int poolSize, String name)
    {
        if (name == null) {
            name = "WorkManager#" + hashCode();
        }
        syncWorkExecutorPool = new NullWorkExecutorPool(poolSize, name);
        startWorkExecutorPool = new NullWorkExecutorPool(poolSize, name);
        scheduledWorkExecutorPool = new NullWorkExecutorPool(poolSize, name);
    }
