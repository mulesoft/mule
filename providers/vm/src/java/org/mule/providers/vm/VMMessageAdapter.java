...
/**
 * <code>VMMessageAdapter</code> provides a common abstraction of Mule Event message.
...
public class VMMessageAdapter extends AbstractMessageAdapter
{
    ...
    {
        if (message == null) throw new MessageTypeNotSupportedException(null, getClass());
