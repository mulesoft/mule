...
public class ConnectionFactoryWrapper implements ConnectionFactory, QueueConnectionFactory, TopicConnectionFactory {
	...
	public TopicConnection createTopicConnection() throws JMSException {
		...
		TopicConnection proxy = (TopicConnection) Proxy.newProxyInstance(
				Connection.class.getClassLoader(),
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			if (method.getName().equals("createSession")) {
				...
				return (Session) Proxy.newProxyInstance(
						...
						new SessionInvocationHandler(xaqs.getQueueSession(), xaqs.getXAResource()));
				...
				return (Session) Proxy.newProxyInstance(
						...
						new SessionInvocationHandler(xats.getTopicSession(), xats.getXAResource()));
			} else {
