...
public interface HttpConstants
{
    ...
    public static final String[] REQUEST_HEADER_NAMES = new String[] { HEADER_ACCEPT, HEADER_ACCEPT_CHARSET,
            ...
            HEADER_MAX_FORWARDS, HEADER_PRAGMA, HEADER_PROXY_AUTHORIZATION, HEADER_RANGE, HEADER_REFERER, HEADER_TE,
            HEADER_TRAILER, HEADER_TRANSFER_ENCODING, HEADER_UPGRADE, HEADER_USER_AGENT, HEADER_VIA, HEADER_WARNING };

    public static final String[] RESPONSE_HEADER_NAMES = new String[] { HEADER_ACCEPT_RANGES, HEADER_AGE, HEADER_ALLOW,
            HEADER_CACHE_CONTROL, HEADER_CONNECTION, HEADER_CONTENT_ENCODING, HEADER_CONTENT_LANGUAGE, HEADER_CONTENT_LENGTH,
            HEADER_CONTENT_LOCATION, HEADER_CONTENT_MD5, HEADER_CONTENT_RANGE, HEADER_CONTENT_TYPE, HEADER_DATE,
            HEADER_ETAG, HEADER_EXPIRES, HEADER_LAST_MODIFIED, HEADER_LOCATION, HEADER_PRAGMA,
            HEADER_PROXY_AUTHENTICATE, HEADER_RETRY_AFTER, HEADER_SERVER, HEADER_TRAILER, HEADER_TRANSFER_ENCODING,
            HEADER_UPGRADE, HEADER_VARY, HEADER_VIA, HEADER_WARNING, HEADER_WWW_AUTHENTICATE };
