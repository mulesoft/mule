...
//            String soapVersionString = PropertiesHelper.getStringProperty(props, "soapVersion", "1.1");
//
...
//                version = new Soap11();
//            } else {
//                throw new InitialisationException(new Message("xfire", 1, version), this);
//            }
            ...
            service = connector.getServiceFactory().create(component.getDescriptor().getImplementationClass(),
