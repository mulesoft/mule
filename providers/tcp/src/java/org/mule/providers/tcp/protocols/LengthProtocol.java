...
/**
 * The LengthProtocol is an application level tcp protocol
 * that can be used to transfer large amounts of data
 * without risking some data to be loss.
 * The protocol is defined by sending / reading an integer
 * (the packet length) and then the data to be transfered. 
 *
