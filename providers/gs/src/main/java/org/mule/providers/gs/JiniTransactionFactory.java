...
/**
 * Creates a Jini Transaction. This factory needs to have the TransactionManager set on it before
 * the <code>beginTransaction</code> method is called on it.  This should be set during start up of
 * the Mule server by the resource that will be sending or receiving events from a JavaSpace.
 *
...
public class JiniTransactionFactory implements UMOTransactionFactory {
     ...
     *          if the transaction cannot be created or
     *          begun
     */
   public UMOTransaction beginTransaction() throws TransactionException
    {
//        if(transactionManager==null) {
//            throw new TransactionException(new Message(Messages.X_IS_NULL, "transactionManager"));
//        }
        try {
