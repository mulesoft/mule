...
public class Pop3FunctionalTestCase extends AbstractMuleTestCase
{
    public void testMailRoundTrip() throws Exception
    {
        ...
        // UMOMessage message =
        // pop3.getDispatcher().receive("pop3://mule:???@mail.muleumo.org",
        // 4000);
        // assertNotNull(message);
        // assertNotNull(message.getPayload());
        // assertEquals("[No Subject]",
        // message.getProperty(MailMessageAdapter.PROPERTY_SUBJECT));
        // assertEquals("ross@muleumo.org",
        // message.getProperty(MailMessageAdapter.PROPERTY_FROM_ADDRESS));
