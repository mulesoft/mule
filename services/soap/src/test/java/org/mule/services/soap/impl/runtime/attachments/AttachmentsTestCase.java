 ...
 * LICENSE.txt file.
 */
package org.mule.services.soap.impl.runtime.attachments;
...
public class AttachmentsTestCase extends AbstractSoapServiceTestCase {
  ...
  public void downloadAttachment() throws Exception {
    SoapRequest request = builder()
        .withContent("<con:downloadAttachment xmlns:con=\"http://service.impl.soap.services.mule.org/\">\n"
    ...
    assertSimilarXml("<ns2:downloadAttachmentResponse xmlns:ns2=\"http://service.impl.soap.services.mule.org/\"/>",
                     response.getContent());
  ...
  public void uploadAttachment() throws Exception {
    SoapRequest request = builder()
        ...
        .withContent("<con:uploadAttachment xmlns:con=\"http://service.impl.soap.services.mule.org/\"/>")
        .withOperation("uploadAttachment")
        .build();
    SoapResponse response = client.consume(request);
    assertSimilarXml("<ns2:uploadAttachmentResponse xmlns:ns2=\"http://service.impl.soap.services.mule.org/\">\n"
        + "    <result>Ok</result>\n"
