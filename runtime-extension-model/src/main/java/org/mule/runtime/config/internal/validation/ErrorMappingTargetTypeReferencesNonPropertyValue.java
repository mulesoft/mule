 ...
 */
public class ErrorMappingTargetTypeReferencesNonPropertyValue extends AbstractErrorTypesValidation {
  ...
  public Optional<ValidationResultItem> validate(ComponentAst component, ArtifactAst artifact) {
    for (ErrorMapping errorMapping : getErrorMappings(component)) {
      final String errorTypeRawValue = errorMapping.getTarget();
