...
import static org.mule.extension.db.api.config.MySqlDbUtils.getEffectiveUrl;
 ...
 * @since 4.0
 */
public final class MySqlDataSourceConfig implements DataSourceConfig {
  ...
  public String getUrl() {
    return getEffectiveUrl(MY_SQL_PREFIX, host, port, database, connectionProperties);
  }
