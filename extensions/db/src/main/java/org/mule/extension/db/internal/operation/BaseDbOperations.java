...
abstract class BaseDbOperations {
  ...
  protected final DefaultQueryResolver queryResolver = new DefaultQueryResolver();
  protected final StoredProcedureQueryResolver storedProcedureResolver = new StoredProcedureQueryResolver();
  ...
  protected Query resolveQuery(StoredProcedureCall call, DbConnector connector, DbConnection connection,
