...
public class DmlOperations extends BaseDbOperations {
  ...
  public InterceptingCallback<Object> select(@ParameterGroup(name = QUERY_GROUP) QueryDefinition query,
                                             @Optional(defaultValue = "false") @Expression(NOT_SUPPORTED) boolean streaming,
                                             @ParameterGroup(name = QUERY_SETTINGS) StatementAttributes statementAttributes,
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult insert(@ParameterGroup(name = QUERY_GROUP) QueryDefinition query,
  ...
  public InterceptingCallback<Map<String, Object>> storedProcedure(@ParameterGroup(name = QUERY_GROUP) StoredProcedureCall call,
                                                                   ...
                                                                   @ParameterGroup(
                                                                       name = QUERY_SETTINGS) StatementAttributes statementAttributes,
                                                                   @ParameterGroup(
