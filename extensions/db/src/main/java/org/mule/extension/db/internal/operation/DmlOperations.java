...
public class DmlOperations extends BaseDbOperations {
   ...
   * @param streaming           if enabled retrieves the result set in blocks so that memory is
   *                            not exhausted in case of large data sets. This works in tandem
   *                            with the fetch size parameter
   ...
   * @return depending on the value of {@code streaming}, it can be a {@link List} or {@link
   * Iterator} of maps
   ...
   * @param streaming                  if enabled retrieves the result set in blocks so that
   *                                   memory is not exhausted in case of large data sets. This
   *                                   works in tandem with the fetch size parameter
   * @param statementAttributes        a {@link StatementAttributes} as a parameter group
   * @param autoGeneratedKeyAttributes an {@link AutoGeneratedKeyAttributes} as a parameter group
   * @param connector                  the acting connector
   * @param connection                 the acting connection
