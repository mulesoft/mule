...
import static org.mule.runtime.extension.api.annotation.param.ParameterGroup.GENERAL;
...
public class DmlOperations extends BaseDbOperations {
  ...
  public InterceptingCallback<Object> select(@ParameterGroup(name = GENERAL) QueryDefinition query,
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult insert(@ParameterGroup(name = GENERAL) QueryDefinition query,
                                @ParameterGroup(name = AUTO_GENERATED_KEYS) AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                @UseConfig DbConnector connector,
                                @Connection DbConnection connection)
      throws SQLException {
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult update(@ParameterGroup(name = GENERAL) QueryDefinition query,
                                @ParameterGroup(name = AUTO_GENERATED_KEYS) AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                @UseConfig DbConnector connector,
                                @Connection DbConnection connection)
      throws SQLException {
   ...
   * @throws SQLException if an error is produced
   */
  public int delete(@ParameterGroup(name = GENERAL) QueryDefinition query,
                    @UseConfig DbConnector connector,
                    @Connection DbConnection connection)
      throws SQLException {
  ...
  public InterceptingCallback<Map<String, Object>> storedProcedure(@ParameterGroup StoredProcedureCall call,
                                                                   ...
                                                                   @ParameterGroup(
                                                                       name = GENERAL) StatementAttributes statementAttributes,
                                                                   @ParameterGroup(
                                                                       name = AUTO_GENERATED_KEYS) AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                                                   @UseConfig DbConnector connector,
                                                                   @Connection DbConnection connection)
      throws SQLException {
