...
public class DmlOperations {
  ...
  private final DefaultQueryResolver queryResolver = new DefaultQueryResolver();
  ...
  private QueryStatementFactory getStatementFactory(StatementAttributes statementAttributes,
                                                    boolean streaming,
  ...
  private StatementResult executeUpdate(QueryDefinition query,
                                        StatementAttributes statementAttributes,
                                        AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                        DbConnection connection, Query resolvedQuery)
      throws SQLException {
  ...
  private Query resolveQuery(StoredProcedureCall call, DbConnector connector, DbConnection connection, QueryType... validTypes) {
