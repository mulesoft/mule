...
import static org.mule.extension.db.internal.operation.AutoGeneratedKeyAttributes.AUTO_GENERATED_KEYS;
...
public class DmlOperations extends BaseDbOperations {
  ...
  public InterceptingCallback<Object> select(@ParameterGroup(QUERY_GROUP) QueryDefinition query,
                                             @Optional(defaultValue = "false") @Expression(NOT_SUPPORTED) boolean streaming,
                                             @ParameterGroup(QUERY_SETTINGS) StatementAttributes statementAttributes,
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult insert(@ParameterGroup(QUERY_GROUP) QueryDefinition query,
                                @ParameterGroup(AUTO_GENERATED_KEYS) AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                @UseConfig DbConnector connector,
                                @Connection DbConnection connection)
      throws SQLException {
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult update(@ParameterGroup(QUERY_GROUP) QueryDefinition query,
                                @ParameterGroup(AUTO_GENERATED_KEYS) AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                @UseConfig DbConnector connector,
                                @Connection DbConnection connection)
      throws SQLException {
   ...
   * @throws SQLException if an error is produced
   */
  public int delete(@ParameterGroup(QUERY_GROUP) QueryDefinition query,
                    @UseConfig DbConnector connector,
                    @Connection DbConnection connection)
      throws SQLException {
  ...
  public InterceptingCallback<Map<String, Object>> storedProcedure(@ParameterGroup(QUERY_GROUP) StoredProcedureCall call,
                                                                   @Optional(
                                                                       defaultValue = "false") @Expression(NOT_SUPPORTED) boolean streaming,
                                                                   @ParameterGroup(
                                                                       value = QUERY_SETTINGS) StatementAttributes statementAttributes,
                                                                   @ParameterGroup(
                                                                       value = AUTO_GENERATED_KEYS) AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                                                   @UseConfig DbConnector connector,
                                                                   @Connection DbConnection connection)
      throws SQLException {
