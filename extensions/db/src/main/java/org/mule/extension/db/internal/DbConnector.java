...
import org.mule.extension.db.internal.domain.connection.datasource.DataSourceConnectionProvider;
...
@ConnectionProviders({DataSourceConnectionProvider.class, GenericConnectionProvider.class, DerbyConnectionProvider.class,
