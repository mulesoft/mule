 ...
 * @since 4.0
 */
public final class DerbyDataSourceConfig implements DataSourceConfig {
  ...
  @ParameterGroup
  private AdvancedDbParameters parametersConfig;
  ...
  public TransactionIsolation getTransactionIsolation() {
    return parametersConfig.getTransactionIsolation();
  }
  ...
  public boolean isUseXaTransactions() {
    return parametersConfig.isUseXaTransactions();
  }
}
