...
public abstract class AbstractSingleQueryExecutor extends AbstractExecutor implements QueryExecutor {
  ...
  public Object execute(DbConnection connection, Query query) throws SQLException {
    ...
    try {
    	...
    	new FailedSqlInfo().logSqlCausingException(LOGGER, query);
    	throw e;
    }
  }

  @Override
  public Object execute(DbConnection connection, Query query, AutoGeneratedKeyStrategy autoGeneratedKeyStrategy)
      throws SQLException {
