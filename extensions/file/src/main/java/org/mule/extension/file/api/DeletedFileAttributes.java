 ...
 * is always associated to a {@link FileEventType#DELETE} event.
 * <p>
 * Because the referenced file has been deleted, most of its attributes
 * (such as size, type, timestamps, etc) are no longer available. Thus,
 * all but the below listed methods will throw {@link IllegalStateException}
 * upon invocation:
 * <p>
 * <ul>
 * <li>{@link #getPath()}</li>
