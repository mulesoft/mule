 ...
 * can erase a single or multiple specified emails from a folder and will also erase all
 * the emails that contains the {@code DELETED} flag.
 *
 * @since 4.0
 */
public final class DeleteCommand
{
    ...
    /**
     * Eliminates from the mailbox the email with id {@code emailId} and all the emails scheduled for deletion
     * (marked as DELETED messages).
     * <p>
