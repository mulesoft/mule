 ...
 * <p>
 * This class is the responsible for looking in the incoming message
 * if there are one or more emailIds to accept and perform the operation
 * when no explicit emailId is specified.
 *
 * @since 4.0
 */
public class EmailIdConsumerExecutor
{
     ...
     * <p>
     * if no emailId is specified, the operation will try to find one or more emails
