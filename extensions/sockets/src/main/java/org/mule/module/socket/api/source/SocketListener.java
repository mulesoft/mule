 ...
 * <p>
 * Whenever a new connection is received, this {@link Source} will schedule a
 * a {@link SocketWorker} that will handle the communication for that particular connection.
 *
 * @since 4.0
 */
