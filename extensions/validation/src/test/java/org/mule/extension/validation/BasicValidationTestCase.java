...
import static org.mule.extension.validation.ValidationExtension.DEFAULT_LOCALE;
...
public class BasicValidationTestCase extends ValidationTestCase
{
    ...
    public void time() throws Exception
    {
        ...
        assertInvalid("time", event, messages.invalidTime(time, DEFAULT_LOCALE, invalidPattern));
    }
    ...
    public void date() throws Exception
    {
        ...
        assertInvalid("date", event, messages.invalidDate(invalidDate, DEFAULT_LOCALE, pattern));
    }
    ...
    public void successfulAll() throws Exception
    {
        ...
        ValidationResult result = (ValidationResult) responseEvent.getMessage().getPayload();
    ...
    public void failureInAllThrowsException() throws Exception
    {
        ...
        catch (Exception e)
        {
            ...
            assertThat(root, is(instanceOf(ValidationException.class)));
            ValidationResult result = ((ValidationException) root).getValidationResult();
            assertThat(result.isError(), is(true));
            assertThat(result.getMessage(), is(messages.invalidEmail(INVALID_EMAIL).getMessage()));
        }
    }
