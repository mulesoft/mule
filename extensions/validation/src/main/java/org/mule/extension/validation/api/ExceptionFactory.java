...
public interface ExceptionFactory
{
     ...
     */
    <T extends Exception> T createException(ValidationResult result, Class<T> exceptionClass);
     ...
     */
    Exception createException(ValidationResult result, String exceptionClassName);
}
