...
import org.mule.extension.validation.validator.I18NConfig;
...
@Operations({CommonValidationOperations.class, CustomValidatorOperation.class})
...
public class ValidationExtension implements Config, Initialisable, MuleContextAware
{
    ...
    private void initialiseExceptionFactory() throws InitialisationException
    {
        ...
        try
        {
            ...
            muleContext.getRegistry().registerObject(objectNameHelper.getUniqueName("exceptionFactory"), exceptionFactory);
        }
