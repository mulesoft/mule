...
public final class ValidatorElContext {
  ...
  /**
   * Validates that {@code value} matches the given {@code regex} using a {@link MatchesRegexValidator}
   *
  ...
  /**
   * Validates that {@code time} represents a time according to the given {@code pattern} an the default locale
   * {@link ValidationExtension#DEFAULT_LOCALE) using a {@link TimeValidator}
   *
  ...
  /**
   * Validates that {@code value} is empty by using a {@link EmptyValidator}
   *
   * @param value the value to check
   * @return {@code true} if the validation succeeded. {@code false} otherwise
   */
  ...
  /**
   * Validates that {@code value} is not empty by using a {@link NotEmptyValidator}
   *
   * @param value the value to check
   * @return {@code true} if the validation succeeded. {@code false} otherwise
   */
  ...
  /**
   * Validates that {@code value} has a size between certain inclusive boundaries by using a {@link SizeValidator}
   *
  ...
  /**
   * Validates that {@code value} can be parsed into a {@link Number}, by the rules of a {@link NumberValidator}.
   * <p/>
  ...
  /**
   * Validates that an {@code ip} address represented as a {@link String} is valid by using a {@link IpValidator}
   *
  ...
  /**
   * Validates that {@code url} is a valid one by using a {@link UrlValidator}.
   *
