...
public final class ValidationMessages extends MessageFactory {
  ...
  /**
   * Generates a {@link Message} for an email validation that failed
   *
  ...
  /**
   * Generates a {@link Message} for an ip address validation that failed
   *
  ...
  /**
   * Generates a {@link Message} for a value that was expected to have a minimum size but didn't
   *
  ...
  /**
   * Generates a {@link Message} for a value that was expected to have a maximum size but didn't
   *
   * @param value the tested value
  ...
  /**
   * Generates a {@link Message} for a value that is {@code null} what it wasn't expected to be
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a value that was expected to be not empty but was
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a string that was expected to be not blank but wasn't
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a map that was expected to be not empty but was
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a value that was expected to not be a {@link BlankLiteral} but was
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a value that was expected to be {@code null} but wasn't
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a {@code value} which doesn't match a given {@code regex}
   *
   * @param value the tested value
  ...
  /**
   * Generates a {@link Message} for an array which was expected to be not empty but was
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a String which was expected to be blank but wasn't
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a {@link Collection} which was expected to be empty but wasn't
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for a {@link Map} which was expected to be empty but wasn't
   *
   * @return a {@link Message}
   */
  ...
  /**
   * Generates a {@link Message} for an array which was expected to be empty but wasn't
   *
   * @return a {@link Message}
   */
