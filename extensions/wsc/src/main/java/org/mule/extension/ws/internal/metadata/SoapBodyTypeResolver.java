 ...
 * @since 4.0
 */
public class SoapBodyTypeResolver extends MessageBuilderResolver implements InputTypeResolver<String> {
  ...
  public MetadataType getInputMetadata(MetadataContext context, String operationName)
    ...
    return getSoapMetadata(context, operationName).getBodyType();
  }
}
