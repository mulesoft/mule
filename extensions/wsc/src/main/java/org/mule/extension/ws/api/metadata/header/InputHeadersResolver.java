...
import org.mule.extension.ws.api.metadata.InputTypeResolverDelegate;
...
public class InputHeadersResolver extends HeadersElementResolver implements InputTypeResolver<String> {

  public InputHeadersResolver() {
