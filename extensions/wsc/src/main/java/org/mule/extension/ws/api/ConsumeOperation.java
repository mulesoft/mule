...
import org.mule.extension.ws.api.metadata.WscAttributesResolver;
import org.mule.extension.ws.api.metadata.body.InputBodyResolver;
import org.mule.extension.ws.api.metadata.body.OutputBodyResolver;
import org.mule.extension.ws.api.metadata.header.InputHeadersResolver;
...
public class ConsumeOperation {
  ...
  public OperationResult<String, WscAttributes> consume(@Connection WscConnection connection,
                                                        ...
                                                        @Optional @TypeResolver(InputBodyResolver.class) String body,
