...
@Stories("Basic Publish and Subscribe operations test with Connection Provider configuration")
public class GenericProviderBasicTopicTestCase extends JmsBasicTopicPublishAndSubscribe {
