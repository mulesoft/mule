...
set FORCE_IPV4_STACK=-M-Djava.net.preferIPv4Stack=true
...
call %MULE_HOME%\bin\launcher.bat %MULE_HOME%\bin\additional.groovy %_WRAPPER_CONF% "%JPDA_OPTS%" "%MULE_ENDORSED%" "%FORCE_IPV4_STACK%" %*
