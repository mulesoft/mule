...
@WebServiceClient(name = "HolderServiceService", wsdlLocation = "echoHolder.wsdl",
    targetNamespace = "http://cxf.module.compatibility.mule.org/")
public class HolderServiceService extends Service {

  public final static URL WSDL_LOCATION;

  public final static QName SERVICE = new QName("http://cxf.module.compatibility.mule.org/", "HolderServiceService");
  public final static QName HolderServicePort = new QName("http://cxf.module.compatibility.mule.org/", "HolderServicePort");
  static {
    URL url = null;
    try {
