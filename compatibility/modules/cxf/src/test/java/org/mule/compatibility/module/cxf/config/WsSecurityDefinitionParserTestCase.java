...
import static org.apache.ws.security.handler.WSHandlerConstants.ENC_PROP_FILE;
...
import static org.apache.ws.security.handler.WSHandlerConstants.SIG_PROP_FILE;
...
public class WsSecurityDefinitionParserTestCase extends FunctionalTestCase {
  ...
  public void testWsSecurityConfig() {
    ...
    assertEquals("org.mule.compatibility.module.cxf.wssec.ClientPasswordCallback",
  ...
  public void testWsSecurityConfig2() {
    ...
    assertEquals(TIMESTAMP + " " + SIGNATURE + " " + ENCRYPT, wsProperties.get(ACTION));
    assertEquals("joe", wsProperties.get(USER));
    assertEquals("org/mule/compatibility/module/cxf/wssec/wssecurity.properties", wsProperties.get(SIG_PROP_FILE));
    assertEquals("org/mule/compatibility/module/cxf/wssec/wssecurity.properties",
                 wsProperties.get(ENC_PROP_FILE));
    assertTrue(wsProperties.get(PW_CALLBACK_REF) instanceof ClientPasswordCallback);
  }
