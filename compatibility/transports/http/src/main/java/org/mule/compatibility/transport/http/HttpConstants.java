...
public class HttpConstants {
  ...
  public static final String HEADER_CONTENT_TYPE = HttpHeaders.CONTENT_TYPE; // [Entity]
  ...
  static {
    ...
    Map<String, String> allHeaders = MapUtils.mapWithKeysAndValues(CaseInsensitiveMap.class, strings, strings);
