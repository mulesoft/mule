 ...
 * be needed, for example GroupCorrelation IDs in order to be able to aggregate messages after chunking. Data are read until no
 * more are (momentarily) available.
 */
