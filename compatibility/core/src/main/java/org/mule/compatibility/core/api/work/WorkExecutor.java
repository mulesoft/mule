 ...
 * LICENSE.txt file.
 */
package org.mule.compatibility.core.api.work;

import org.mule.compatibility.core.work.WorkerContext;
...
public interface WorkExecutor {
   ...
   * @throws InterruptedException Indicates that the thread in charge of the execution of the specified work has been interrupted.
   */
