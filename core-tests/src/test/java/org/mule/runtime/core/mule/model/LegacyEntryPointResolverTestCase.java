...
public class LegacyEntryPointResolverTestCase extends AbstractMuleContextTestCase {
  ...
  public void testFailEntryPointMultiplePayloadMatches() throws Exception {
    ...
    try {
      ...
      setCurrentEvent(Event.builder(DefaultEventContext.create(flowConstruct, fromSingleComponent(TEST_CONNECTOR)))
          .message(of("Hello"))
          .build());
  ...
  public void testArrayArgumentResolution() throws Exception {
    ...
    FlowConstruct flowConstruct = MuleTestUtils.getTestFlow(muleContext);
    Event event = Event.builder(DefaultEventContext.create(flowConstruct, fromSingleComponent(TEST_CONNECTOR)))
