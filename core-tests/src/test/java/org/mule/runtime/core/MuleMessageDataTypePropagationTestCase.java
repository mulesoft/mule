...
public class MuleMessageDataTypePropagationTestCase extends AbstractMuleTestCase
{
    ...
    public void usesDefaultEncodingWithNoProperty() throws Exception
    {
        ...
        assertThat(muleMessage.getDataType().getMimeType().getEncoding().get(), equalTo(DEFAULT_ENCODING));
    ...
    {
        DefaultMuleMessage muleMessage = new DefaultMuleMessage(TEST, buildDefaultEncodingDataType());
        muleMessage.setDataType(DataType.builder().encoding(CUSTOM_ENCODING).build());

        assertThat(muleMessage.getDataType().getMimeType().getEncoding().get(), equalTo(CUSTOM_ENCODING));
    }
    ...
    public void setsDataTypeFromPreviousMessageOnCreation() throws Exception
    {
        ...
        DataType dataType = DataType.builder().type(Long.class).mimeType(APPLICATION_XML).encoding(CUSTOM_ENCODING).build();
    ...
    {
        DefaultMuleMessage previousMuleMessage = new DefaultMuleMessage(1, buildDefaultEncodingDataType());
        previousMuleMessage.setDataType(DataType.builder().mimeType(APPLICATION_XML).encoding(CUSTOM_ENCODING).build());
    ...
    {
        DefaultMuleMessage muleMessage = new DefaultMuleMessage(TEST, buildDefaultEncodingDataType());
        muleMessage.setDataType(DataType.builder().mimeType(APPLICATION_XML).encoding(CUSTOM_ENCODING).build());
    ...
    {
        DefaultMuleMessage muleMessage = new DefaultMuleMessage(TEST, buildDefaultEncodingDataType());
        muleMessage.setDataType(DataType.builder().mimeType(APPLICATION_XML).build());

        Transformer transformer = mock(Transformer.class);
        when(transformer.isSourceDataTypeSupported(org.mockito.Matchers.<DataType<?>>any())).thenReturn(true);
        DataType outputDataType = DataType.builder().type(Integer.class).mimeType(ANY).encoding(DEFAULT_ENCODING).build();
    ...
    {
        DefaultMuleMessage muleMessage = new DefaultMuleMessage(TEST, buildDefaultEncodingDataType());
        muleMessage.setDataType(DataType.builder().mimeType(ANY).encoding(CUSTOM_ENCODING).build());
    ...
    public void maintainsDataTypeOnGetPayloadTransformation() throws Exception
    {
        ...
        assertThat(muleMessage.getDataType().getMimeType().getPrimaryType(), equalTo(APPLICATION_XML.getPrimaryType()));
        assertThat(muleMessage.getDataType().getMimeType().getSubType(), equalTo(APPLICATION_XML.getSubType()));
        assertThat(muleMessage.getDataType().getMimeType().getEncoding().get(), equalTo(CUSTOM_ENCODING));
    }
    ...
    {
        return DataType.builder(DataType.OBJECT).encoding(getDefaultEncoding(muleContext)).build();
    }
