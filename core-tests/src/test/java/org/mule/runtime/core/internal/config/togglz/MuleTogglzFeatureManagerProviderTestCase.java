...
import org.mule.runtime.core.internal.config.togglz.activation.strategies.MuleTogglzActivatedIfEnabledActivationStrategy;
...
public class MuleTogglzFeatureManagerProviderTestCase {
  ...
  public void featureNotExisting() {
    ...
    expectedException
        .expectMessage(String.format(MuleTogglzFeatureStateRepository.FEATURE_IS_NOT_REGISTERED, MOCKED_FEATURE_NAME));
