...
public class MessagePropertiesTestCase extends AbstractELTestCase {
  ...
  public void inboundPropertyMap() throws Exception {
    event = BaseEvent.builder(context)
  ...
  public void inboundContainsKey() throws Exception {
    ...
    mock(DataHandler.class);
    event =
        BaseEvent.builder(event).message(InternalMessage.builder(message).addInboundProperty("foo", "abc").build()).build();
  ...
  public void outboundClear() throws Exception {
    event = BaseEvent.builder(event).message(InternalMessage.builder(event.getMessage()).addOutboundProperty("foo", "abc")
