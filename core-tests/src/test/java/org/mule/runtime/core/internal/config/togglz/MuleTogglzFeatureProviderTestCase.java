...
import static org.mule.runtime.core.internal.processor.strategy.util.ProfilingUtils.getFullyQualifiedProfilingEventTypeFeatureIdentifier;
...
public class MuleTogglzFeatureProviderTestCase {
  ...
  public void muleRuntimeFeaturesAreRegisteredCorrectly() {
    ...
    assertThat(featureProvider.getFeature(TestRuntimeProfilingFeatures.TEST_RUNTIME_FEATURE.toString()), equalTo(feature));
