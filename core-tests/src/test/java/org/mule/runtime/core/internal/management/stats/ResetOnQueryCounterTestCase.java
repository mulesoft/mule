...
public class ResetOnQueryCounterTestCase extends AbstractMuleContextTestCase {
  ...
  public static List<Object[]> params() {
    return asList(
                  ...
                  new Object[] {
                      "messagesDispatched",
                      (Function<FlowConstructStatistics, ResetOnQueryCounter>) FlowConstructStatistics::getMessagesDispatchedCounter,
                      (Consumer<DefaultFlowConstructStatistics>) DefaultFlowConstructStatistics::incDispatchedMessages},
                  new Object[] {
                      "executionErrors",
                  ...
                  new Object[] {
                      ...
                      (Consumer<DefaultFlowConstructStatistics>) DefaultFlowConstructStatistics::incConnectionErrors},
                  new Object[] {
                      "fatalErrors",
