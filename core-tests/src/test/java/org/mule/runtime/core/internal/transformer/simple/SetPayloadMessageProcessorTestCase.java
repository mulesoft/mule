...
public class SetPayloadMessageProcessorTestCase extends AbstractMuleContextTestCase {
  ...
  public void setUp() throws Exception {
    ...
    when(expressionManager.parse(anyString(), any(BaseEvent.class), any(ComponentLocation.class)))
  ...
  public void setsNullPayload() throws MuleException {
    ...
    BaseEvent response = setPayloadMessageProcessor.process(testEvent());
  ...
  public void setsExpressionPayload() throws MuleException {
    ...
    when(expressionManager.evaluate(eq(EXPRESSION), eq(testEvent()), any(BaseEvent.Builder.class), eq(null)))
