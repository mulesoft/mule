...
public class SoapMethodsDefinitionParser extends ChildDefinitionParser
{

    public SoapMethodsDefinitionParser(String setterMethod)
    {
        super(setterMethod, HashMap.class);
    }

    public SoapMethodsDefinitionParser(String setterMethod, Class mapType)
    {
    ...
    protected void parseChild(Element element, ParserContext parserContext, BeanDefinitionBuilder builder)
    {
        ...
        ManagedMap nestedMap = new ManagedMap();
        nestedMap.put("soapMethods", parsedMap);
        builder.addPropertyValue("sourceMap", nestedMap);
