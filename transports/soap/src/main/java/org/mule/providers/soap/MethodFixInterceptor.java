...
import org.mule.config.MuleProperties;
 ...
 /**
  * This Interceptor decorates the current message  with a property that tells the DynamicEntryPointResolver
  * to ignore the 'method' property. The reason being is that for the SOAP endpoints have an additional hop -
  *
  * http ---> AxisServiceComponent ---> WebService
  *
  * the 'method' param is targetted for the WebService not the AxisServiceComponent, so we eed to ignore it
  *
  */
