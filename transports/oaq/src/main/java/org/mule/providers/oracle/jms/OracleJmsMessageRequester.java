...
import org.mule.providers.jms.JmsMessageRequester;
import org.mule.umo.UMOMessage;
import org.mule.umo.endpoint.UMOImmutableEndpoint;

public class OracleJmsMessageRequester extends JmsMessageRequester
{

    public OracleJmsMessageRequester(UMOImmutableEndpoint endpoint)
    {
        super(endpoint);
    }
     ...
     *
     * @see org.mule.providers.oracle.jms.OracleJmsSupport#endpointProperties
    ...
    protected UMOMessage doRequest(long timeout) throws Exception
    {
        ((OracleJmsSupport)((JmsConnector)getConnector()).getJmsSupport()).setEndpointProperties(endpoint.getEndpointURI()
            .getParams());
        return super.doRequest(timeout);
    }
}