...
public class SftpMessageReceiverTestCase extends AbstractMuleTestCase {
    ...
    private static final FileDescriptor[] FILES = new FileDescriptor[]{new FileDescriptor("some-file-1", null), new FileDescriptor("some-file-2", null)};
    ...
    public void createMocks() throws Exception {
        ...
        SftpReceiverRequesterUtil requesterUtil = mock(SftpReceiverRequesterUtil.class);
    ...
    public void lockIsReleased() throws Exception {
        ...
        for (final FileDescriptor file : FILES) {
            verify(lockProvider, times(2)).createLock(receiver.createLockId(file.getFilename()));
        }
    }
    ...
    public void lockContainsEndpointUri() throws Exception {
        for (final FileDescriptor file : FILES) {
            assertThat(receiver.createLockId(file.getFilename()), is(createTestLockId(file.getFilename())));
        }
    }
