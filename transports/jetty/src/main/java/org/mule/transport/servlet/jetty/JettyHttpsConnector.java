...
public class JettyHttpsConnector extends JettyHttpConnector implements TlsDirectKeyStore, TlsIndirectKeyStore, TlsDirectTrustStore, TlsProtocolHandler
{
    ...
    protected AbstractConnector createJettyConnector()
    {
        ...
        if (tls.getTrustStore() != null) sslContextFactory.setTrustStore(tls.getTrustStore());
        if (tls.getTrustStoreType() != null) sslContextFactory.setTrustStoreType(tls.getTrustStoreType());
        if (tls.getTrustManagerAlgorithm() != null) sslContextFactory.setSslKeyManagerFactoryAlgorithm(tls.getTrustManagerAlgorithm());
