 ...
 * <ul>
 * <li>payload - the object to use a the payload, this can be a JSON encoded string. If JSON is used a {@link java.util.Map} will be created. {@link CometdMessageAdapter.PAYLOAD_PARAM}</li>
 * <li>replyTo - the return cometd channel for this message. {@link CometdMessageAdapter.REPLYTO_PARAM}</li>
 * </ul>
 * Any additional properties will be set on the message in the {@link org.mule.api.transport.PropertyScope.INVOCATION} scope.
 */
public class CometdMessageAdapter extends AbstractMessageAdapter
{
    ...
    public CometdMessageAdapter(Object message) throws MessagingException
    {
        super();
        init(message);
    }

    public CometdMessageAdapter(Object message, MessageAdapter template) throws MessagingException
    {
        super(template);
        init(message);
    }
