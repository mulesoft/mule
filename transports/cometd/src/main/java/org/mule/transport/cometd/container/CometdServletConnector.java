 ...
 */
public class CometdServletConnector extends ServletConnector
{
    public static final String PROTOCOL = "cometd-servlet";
    ...
    public void setBayeux(AbstractBayeux bayeux)
    {
        ...
        try
        {
            ...
            {
                ((CometdMessageReceiver)receiver).setBayeux(getBayeux());
            }
            this.start();
        }
