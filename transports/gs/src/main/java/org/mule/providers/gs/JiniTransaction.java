...
public class JiniTransaction extends AbstractSingleResourceTransaction
{
    ...
    public void bindResource(Object key, Object resource) throws TransactionException
    {
        ...
        // We can only start the transaction when its bound as we need the Space to
        ...
        {
            throw new IllegalTransactionStateException(new Message(Messages.TX_CANT_START_X_TRANSACTION,
                "Jini"), e);
        }
