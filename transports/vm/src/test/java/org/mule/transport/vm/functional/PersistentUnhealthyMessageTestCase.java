...
public class PersistentUnhealthyMessageTestCase extends FunctionalTestCase
{
    ...
    {
        FileUtils.createFile(".mule/queuestore/flowOut/unhealthy_message_01.msg");
        FileUtils.createFile(".mule/queuestore/flowOut/unhealthy_message_02.msg");
    }
    ...
    public void testUnhealthyMessageIgnored() throws Exception
    {
        ...
        client.dispatch("vm://fLowEcho", "echo", null);
