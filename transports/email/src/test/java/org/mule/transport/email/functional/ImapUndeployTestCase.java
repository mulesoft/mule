...
public class ImapUndeployTestCase extends AbstractEmailFunctionalTestCase
{
    ...
    {
        super(STRING_MESSAGE, "imap", "imap-undeploy-test.xml");
    }
    ...
    {
        SimpleFlowConstruct flow = (SimpleFlowConstruct) muleContext.getRegistry().lookupFlowConstruct("emailPollingFlow");
