...
/**
 * <code>FilteringListMessageSplitter</code> accepts a List as a message payload then routes list elements as messages
 * over an endpoint where the endpoint's filter accepts the payload.
 * 
