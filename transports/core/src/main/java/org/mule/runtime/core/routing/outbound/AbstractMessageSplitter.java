...
public abstract class AbstractMessageSplitter extends FilteringOutboundRouter
{
    ...
    /**
     * Implementing classes should create a {@link org.mule.runtime.core.routing.outbound.SplitMessage} instance and for
     ...
     * a round-robin way, they should use the {@link org.mule.runtime.core.routing.outbound.AbstractRoundRobinMessageSplitter} instead.
     *
     * @param message   the current message being processed
     * @param endpoints A list of {@link org.mule.runtime.core.api.endpoint.OutboundEndpoint} that will be used to dispatch each of the parts
     * @return a {@link org.mule.runtime.core.routing.outbound.SplitMessage} instance that contains the message parts and the
     *         endpoint to associate with the message part.
     * @see org.mule.runtime.core.routing.outbound.SplitMessage
     * @see org.mule.runtime.core.routing.outbound.AbstractRoundRobinMessageSplitter
     */
