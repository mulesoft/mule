...
/**
 * <code>EndpointURI</code> is used to determine how a message is sent or received. The url defines the protocol, the
 * endpointUri destination of the message and optionally the endpoint to use when dispatching the event. Mule urls take
...
public interface EndpointURI extends Serializable, Initialisable
{
     ...
     *
     * @return The decoded user component of this EndpointURI, or {@code null} if the user is undefined
     */
    String getUser();
     ...
     *
     * @return The decoded password component of this EndpointURI, or {@code null} if the password is undefined
     */
    String getPassword();
