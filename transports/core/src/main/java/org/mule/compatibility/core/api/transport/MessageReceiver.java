 ...
 * interface will also implement the listener interface for the external system. For example to listen to a JMS
 * destination the developer would also implement javax.jms.MessageListener. The endpoint (which creates the
