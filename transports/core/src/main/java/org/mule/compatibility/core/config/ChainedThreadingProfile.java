 ...
 * {@link org.mule.compatibility.core.config.ChainedThreadingProfile#ChainedThreadingProfile(ThreadingProfile)} will switch behaviour
...
public class ChainedThreadingProfile implements ThreadingProfile {
  ...
  /**
   * Generate a mutable threading profile with fixed default values taken from {@link #DEFAULT_THREADING_PROFILE}
   */
