...
/**
 * <code>AbstractMessageSplitter</code> is an outbound Message Splitter used to split the contents of a received message
 * into sub parts that can be processed by other components. Each Part is fired as a separate event to each endpoint on
 * the router. The targets can have filters on them to receive only certain message parts.
 * 
...
public abstract class AbstractMessageSplitter extends FilteringOutboundRouter
{
    ...
    /**
     * Implementing classes should create a {@link org.mule.compatibility.core.routing.outbound.SplitMessage} instance and for
     ...
     * a round-robin way, they should use the {@link org.mule.compatibility.core.routing.outbound.AbstractRoundRobinMessageSplitter} instead.
     *
     * @param message   the current message being processed
     * @param endpoints A list of {@link org.mule.compatibility.core.api.endpoint.OutboundEndpoint} that will be used to dispatch each of the parts
     * @return a {@link org.mule.compatibility.core.routing.outbound.SplitMessage} instance that contains the message parts and the
     *         endpoint to associate with the message part.
     * @see org.mule.compatibility.core.routing.outbound.SplitMessage
     * @see org.mule.compatibility.core.routing.outbound.AbstractRoundRobinMessageSplitter
     */
