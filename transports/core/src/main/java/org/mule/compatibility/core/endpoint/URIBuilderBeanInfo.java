...
public class URIBuilderBeanInfo extends SimpleBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    try {
      ...
      return new PropertyDescriptor[] {new PropertyDescriptor("address", URIBuilder.class, null, "setAddress"),
          ...
          new PropertyDescriptor("path", URIBuilder.class, null, "setPath"), new PropertyDescriptor("port", null, setPort),
