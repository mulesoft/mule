...
import org.mule.runtime.core.config.i18n.TransportCoreMessages;
...
public class FileConnector extends AbstractConnector
{
    ...
    public MessageReceiver createReceiver(FlowConstruct flowConstruct, InboundEndpoint endpoint) throws Exception
    {
        ...
        catch (Exception e)
        {
            throw new InitialisationException(
                    TransportCoreMessages.failedToCreateObjectWith("Message Receiver",
    ...
    public OutputStream getOutputStream(OutboundEndpoint endpoint, MuleEvent event) throws MuleException
    {
        ...
        if (writeToDirectory != null)
        {
            address = getFilenameParser().getFilename(event, writeToDirectory);
        }
        ...
        try
        {
            ...
            else
            {
                ...
                if (filename == null)
                {
                    filename = generateFilename(event, null);
                }
            }
    ...
    private String generateFilename(MuleEvent event, String pattern)
    {
        ...
        return getFilenameParser().getFilename(event, pattern);
    }
