...
public class MuleSessionHandlerTestCase extends AbstractMuleTestCase {
  ...
  private Serializable removeProperty(MuleEvent event, MuleEvent.Builder builder) {
