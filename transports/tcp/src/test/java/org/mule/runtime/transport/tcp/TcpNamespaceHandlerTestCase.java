...
import org.mule.runtime.transport.tcp.LocalSocketTcpMessageDispatcherFactory;
import org.mule.runtime.transport.tcp.PollingTcpConnector;
import org.mule.runtime.transport.tcp.TcpClientSocketProperties;
import org.mule.runtime.transport.tcp.TcpConnector;
import org.mule.runtime.transport.tcp.TcpProtocol;
import org.mule.runtime.transport.tcp.TcpServerSocketProperties;
import org.mule.runtime.transport.tcp.TcpSocketFactory;
import org.mule.runtime.transport.tcp.protocols.AbstractByteProtocol;
...
public class TcpNamespaceHandlerTestCase extends FunctionalTestCase
{
    ...
    {
        TcpConnector connector = (TcpConnector) muleContext.getRegistry().lookupObject(name);
    ...
    {
        PollingTcpConnector c = (PollingTcpConnector) muleContext.getRegistry().lookupObject("pollingConnector");
        assertNotNull(c);
