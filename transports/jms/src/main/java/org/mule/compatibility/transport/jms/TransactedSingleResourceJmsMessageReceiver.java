...
import org.mule.runtime.api.lifecycle.StopException;
...
public class TransactedSingleResourceJmsMessageReceiver extends AbstractMessageReceiver implements MessageListener {
  ...
  public TransactedSingleResourceJmsMessageReceiver(Connector connector, FlowConstruct flowConstruct, InboundEndpoint endpoint)
