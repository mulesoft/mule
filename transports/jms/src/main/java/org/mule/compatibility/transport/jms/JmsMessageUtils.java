...
public class JmsMessageUtils {
   ...
   *        BytesMessage.
   * @param jmsSpec indicates the JMS API version, either {@link JmsConstants#JMS_SPECIFICATION_102B} or
   *        {@link JmsConstants#JMS_SPECIFICATION_11}. Any other value including <code>null</code> is treated as fallback to
