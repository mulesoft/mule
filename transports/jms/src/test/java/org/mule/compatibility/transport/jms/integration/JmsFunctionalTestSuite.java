...
/**
 * A test suite for JUnit 4 consisting of all JMS functional tests which have been parameterized in order to support more than one
 * JMS provider. This test suite can be run/debugged conveniently from an IDE (e.g., in Eclipse "Run As/JUnit Test").
 */
@RunWith(Suite.class)
@SuiteClasses({JmsClientAcknowledgeTransactionTestCase.class, JmsConnectorJndiTestCase.class, JmsDurableTopicTestCase.class,
    ...
    JmsTransformersTestCase.class, JmsXAAlwaysBeginTestCase.class})
