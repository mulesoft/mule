...
public class MultiConsumerJmsMessageReceiverTest extends AbstractMuleTestCase
{
    ...
    public void messageListenerNotSetTwiceOnMessageReceiver() throws Exception
    {
        ...
        when(mockJmsConnector.getMuleContext().getRegistry().get(MuleProperties.OBJECT_DEFAULT_MESSAGE_PROCESSING_MANAGER)).thenReturn(mock(MessageProcessingManager.class));
