 ...
 * available from the JNDI context --> <spring:prop
 * key="queue.in2">in-queue2</spring:prop> <spring:prop
 * key="topic.some/long/path/in3">in-topic3</spring:prop> </util:properties>
 * </spring:beans>
 */
