...
import org.mule.runtime.transport.http.config.HttpNamespaceHandler;
import org.mule.runtime.transport.http.i18n.HttpMessages;
import org.mule.runtime.transport.http.ntlm.NTLMScheme;
...
public class HttpConnector extends TcpConnector
{
    ...
    private org.mule.runtime.transport.http.HttpConnectionManager connectionManager;
    ...
    protected void doInitialise() throws InitialisationException
    {
        ...
        if (connectionManager == null)
        {
            try
            {
                connectionManager = new org.mule.runtime.transport.http.HttpConnectionManager(this, getReceiverWorkManager());
            }
    ...
    protected void doStart() throws MuleException
    {
        ...
        if (this.connectionManager == null)
        {
            this.connectionManager = new org.mule.runtime.transport.http.HttpConnectionManager(this,getReceiverWorkManager());
        }
    }
