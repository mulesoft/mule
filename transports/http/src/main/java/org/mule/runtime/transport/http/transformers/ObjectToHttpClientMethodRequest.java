...
import org.mule.runtime.transport.http.StreamPayloadRequestEntity;
import org.mule.runtime.transport.http.i18n.HttpMessages;
import org.mule.runtime.transport.http.multipart.MultiPartInputStream;
        ...
        throws Exception
    {
        ...
        for (final Iterator<String> iterator = msg.getOutboundAttachmentNames().iterator(); iterator.hasNext(); i++)
        {
            ...
            else
            {
                ...
                {
                    org.mule.runtime.transport.http.multipart.Part part = ((PartDataSource) dh.getDataSource()).getPart();
