...
//          httpServer.setThreadPool(threadPool);
        ...
        Connector cnn = createJettyConnector();

        cnn.setPort(uri.getPort());
        cnn.setMaxIdleTime(30000);
