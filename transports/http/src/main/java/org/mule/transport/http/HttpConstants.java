...
public class HttpConstants
{
    ...
    public static final String HEADER_CLOSE = "Close"; // [General]
    ...
    static
    {
        String[] strings = new String[]{HEADER_ACCEPT, HEADER_ACCEPT_CHARSET, HEADER_ACCEPT_ENCODING,
            HEADER_ACCEPT_LANGUAGE, HEADER_AUTHORIZATION, HEADER_CACHE_CONTROL,  HEADER_CLOSE, HEADER_CONNECTION,
        ...
        strings = new String[]{HEADER_ACCEPT_RANGES, HEADER_AGE, HEADER_ALLOW, HEADER_CACHE_CONTROL,
            HEADER_CLOSE, HEADER_CONNECTION, HEADER_CONTENT_ENCODING, HEADER_CONTENT_DISPOSITION, 
        ...
        strings = new String[]{HEADER_ALLOW, HEADER_CACHE_CONTROL,  HEADER_CLOSE, HEADER_CONNECTION, 
