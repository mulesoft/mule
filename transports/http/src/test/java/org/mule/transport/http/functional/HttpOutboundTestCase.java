...
public class HttpOutboundTestCase extends AbstractMockHttpServerTestCase
{
    ...
    @Override
    protected MockHttpServer getHttpServer(CountDownLatch startupLatch, CountDownLatch testCompleteLatch)
    {
        return new SimpleHttpServer(dynamicPort.getNumber(), startupLatch, testCompleteLatch);
    }
