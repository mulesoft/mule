...
public class HttpRequestBodyToParamMapTestCase extends AbstractMuleTestCase
{
    ...
    {
        MuleMessage msg = createMessage("GET", "text/plain");
    ...
    {
        MuleMessage msg = createMessage("POST", "application/x-www-form-urlencoded");
        verifyTransformation(transform(msg));
    }
    ...
    {
        MuleMessage msg = createMessage("PUT", "application/x-www-form-urlencoded");
        verifyTransformation(transform(msg));
    }
    ...
    {
        MuleMessage msg = createMessage("POST", "application/json");
        transform(msg);
    }
