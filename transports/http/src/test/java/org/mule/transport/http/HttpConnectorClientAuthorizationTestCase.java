...
public class HttpConnectorClientAuthorizationTestCase extends AbstractMuleContextTestCase
{
    ...
    public void testWithCredentials() throws Exception
    {
        ...
        c.setupClientAuthorization(mockMuleEvent, mockHttpMethod, mockHttpClient, mockImmutableEndpoint);
    ...
    public void testWithProxyAuth() throws Exception
    {
        ...
        HttpConnector c = (HttpConnector) getConnector();
        c.setProxyUsername(CREDENTIALS_USER);
        c.setProxyPassword(CREDENTIALS_PASSWORD);
        c.setupClientAuthorization(mockMuleEvent, mockHttpMethod, mockHttpClient, mockImmutableEndpoint);
    ...
    public void testClean() throws Exception
    {
        ...
        HttpConnector c = (HttpConnector) getConnector();
        c.setProxyUsername(null);
        c.setProxyPassword(null);
        c.setupClientAuthorization(mockMuleEvent, mockHttpMethod, mockHttpClient, mockImmutableEndpoint);
    ...
    {
        HttpConnector connector = new HttpConnector(muleContext);
