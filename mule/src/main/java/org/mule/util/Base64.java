...
public class Base64
{
     ...
     * large enough to accomodate <var>srcOffset</var> + 3 for the <var>source</var>
     * array or <var>destOffset</var> + 4 for the <var>destination</var> array. The
     ...
     * will return <tt>null</tt>. The object is not GZip-compressed before being
     * encoded.
     * 
     ...
     * be manipulated anywhere along their length by specifying <var>srcOffset</var> and
     * <var>destOffset</var>. This method does not check to make sure your arrays are
     * large enough to accomodate <var>srcOffset</var> + 4 for the <var>source</var>
     * array or <var>destOffset</var> + 3 for the <var>destination</var> array. This
     * method returns the actual number of bytes that were converted from the Base64
     * encoding.
     * 
     * 
     * @param source
                    ...
                    int destOffset)
    {
        ...
        // Example: DkLE
            ...
            try {
                ...
                msg.append(source[srcOffset]).append(": ")
                                .append(DECODABET[source[srcOffset]]);
                msg.append(source[srcOffset + 1]).append(": ").append(
                                DECODABET[source[srcOffset + 1]]);
                msg.append(source[srcOffset + 2]).append(": ").append(
                                DECODABET[source[srcOffset + 2]]);
                msg.append(source[srcOffset + 3]).append(": ").append(
    ...
    public static byte[] decode(byte[] source, int off, int len)
    {
        ...
        for (i = off; i < off + len; i++) {
            ...
            // better
            {
                ...
                new IllegalArgumentException("Bad Base64 input character at " + i + ": "
                                + source[i] + "(decimal)");
            } // end else:
    ...
    public static class InputStream extends FilterInputStream
    {
         ...
         * bytes are read. Returns number of bytes read into array or -1 if end of stream
         * is encountered.
         * 
         * @param dest
