 ...
 * </p>
 * <ul>
 *  <li>current - cleaned by Holger Hoffstaette (holger@codehaus.org) for Mule;
...
public class Base64
{
    ...
    public static byte[] decode(String s)
    {
        ...
        if (bytes != null && bytes.length >= 4) {
            ...
            if (GZIPInputStream.GZIP_MAGIC == head) {
                ...
                try {
                    baos = new ByteArrayOutputStream(0124);
    ...
    public static byte[] decodeFromFile(String filename) throws IOException
    {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new FileInputStream(
                    file)), Base64.DECODE);
    ...
    public static class InputStream extends FilterInputStream
    {
         ...
         * 
         * @param in
         *            the <tt>InputStream</tt> from which to read
         *            data.
         * @since 1.3
         */
