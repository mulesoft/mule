 ...
 * It is the main entry point for operations on counters.
 * The user can:<ul>
...
public class CounterFactory {
	 ...
	 * The type of a counter is defined on creation and can
	 * be retrieved on each counter. 
	 * 
	 * @author gnt
	 */
	...
	/** 
	 * Search the defined counters for a counter of the 
	 * given name.
	 * 
