...
/**
 * <code>MessageEventListener</code> is an observer interface that objects
 * can use to receive events about messages being sent and received from a Mule Server
 * 
 * 
