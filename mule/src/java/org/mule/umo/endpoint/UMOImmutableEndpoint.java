...
/**
 * <code>UMOImmutableEndpoint</code> describes a Message endpoint where data is sent
...
public interface UMOImmutableEndpoint extends Serializable, Cloneable, Initialisable
{
    ...
    /**
     * @return true if this endpoint is read-only and none of it's properties can change.
     ...
     * @return the transaction configuration for this endpoint or null
