...
public interface CoreMessageConstants
{
    ...
    int CANT_START_DISPOSED_CONNECTOR = 32;
    ...
    int METHOD_X_NOT_FOUND_ON_X = 109;
    ...
    int NO_ENTRY_POINT_FOUND_ON_X = 116;
    ...
    int TEMPLATE_X_CAUSED_MALFORMED_ENDPOINT_X=193;
    int COULD_NOT_DETERMINE_DESTINATION_COMPONENT_FROM_ENDPOINT_X=194;
    int COULD_NOT_FIND_SOAP_PROVIDER_X=195;
    int TX_NO_CURRENT_TRANSACTION=196;
}
