 ...
 * event received over Http you can check for Http Headers or For Jms you can check
 * for Jms Headers.
 * The pattern should be expresed as a key/value pair i.e.
 *
 * propertyName=value
 *
 ...
 *
 * By default the comparison is case sensitive you you can sent the <i>caseSensitive</i> property
 * to override this.
 *
...
public class MessagePropertyFilter extends MessageFilter
{
    ...
    protected boolean compare(String value1, String value2) {
        ...
        if(value1==null && value2!=null && !"null".equals(value2) && not) return true;
