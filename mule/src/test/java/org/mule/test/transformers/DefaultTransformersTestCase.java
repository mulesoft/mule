...
/**
 * <code>DefaultTransformersTestCase</code> TODO (document class)
 *
 * @author <a href="mailto:ross.mason@cubis.co.uk">Ross Mason</a>
 * @version $Revision$
 */
public class DefaultTransformersTestCase extends AbstractTransformerTestCase
{
    /* (non-Javadoc)
    ...
    {
        return new ReverseCompressionTransformer();
    }
