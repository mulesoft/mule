...
public class RoundRobinXmlSplitterTestCase extends AbstractMuleTestCase
{
    ...
    {
        String payload = FileUtils.loadResourceAsString("purchase-order2.xml", getClass());
    ...
    private class ItemNodeConstraint implements Constraint
    {
        public boolean eval(Object o)
        {
            ...
            return "872-AA".equals(partNumber) || "926-AA".equals(partNumber) || "126-AA".equals(partNumber) || "226-AA".equals(partNumber);
        }
    }
}
