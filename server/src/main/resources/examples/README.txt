...
Many of the examples are ready to run out-of-the-box and it is not necessary for 
you to build them.  However, some require additional libraries not included as 
part of the Mule distribution.  When this is the case, the additional libraries 
will be downloaded into the $MULE_HOME/lib/user directory upon building the 
example.
