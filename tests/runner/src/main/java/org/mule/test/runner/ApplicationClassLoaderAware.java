...
/**
 * Defines that a test running with {@link ArtifactClassLoaderRunner} would need to get access to the Mule application class
 * loader in order to load classes from it.
 * <p/>
