...
import static org.mule.test.runner.utils.TroubleshootingUtils.copyPluginToAuxJenkinsFolderForTroubleshooting;
import static org.mule.test.runner.utils.TroubleshootingUtils.generateHeapDumpInAuxJenkinsFolder;
      ...
      List<Class> extensionsAnnotatedClasses = urlClassNames
          ...
          .map(urlClassName -> {
            try {
              ...
              try {
                copyPluginToAuxJenkinsFolderForTroubleshooting(firstURL);
                generateHeapDumpInAuxJenkinsFolder(firstURL);
