 ...
 */
public class JmsReconnectionTestCase extends AbstractJmsFunctionalTestCase
...
//        }
    ...
    protected void doSetUp() throws Exception
    {
        ...
        builder.registerComponent(FunctionalTestComponent.class.getName(), "testJmsReconnection",
            getReceiverEndpoint("jms://reconnect.queue"), null, null);
    }
    ...
    protected String checkPreReqs()
    {
        ...
        {
            return "You must set the "
                   + ServerTools.ACTIVEMQ_HOME
    ...
    public void testReconnection() throws Exception
    {
        ...
        while (true)
        {
            ConnectionNotification event = (ConnectionNotification)events.poll(TIME_OUT,
