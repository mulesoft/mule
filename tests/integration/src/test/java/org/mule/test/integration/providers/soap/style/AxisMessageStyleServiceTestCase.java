...
=*/
package org.mule.test.integration.providers.soap.style;
...
public class AxisMessageStyleServiceTestCase extends IntegrationTestCase {
    private static String expectedResult = "TEST RESPONSE";

    public String getConfigResources() {
        return "org/mule/test/integration/providers/soap/style/axis-mule-message-config.xml";
    }
