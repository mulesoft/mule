...
public class GlueConnectorHttpFunctionalTestCase extends AbstractSoapUrlEndpointFunctionalTestCase
{
    ...
    // I've had to overload this method because depending on the network adapter
    // being used the WSDL location url will change between the loopback address and
    // machine IP
