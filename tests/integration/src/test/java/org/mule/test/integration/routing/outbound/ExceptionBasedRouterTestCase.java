...
public class ExceptionBasedRouterTestCase extends FunctionalTestCase
{
    ...
    public void testDynamicEndpointsByURI() throws Exception
    {
        ...
        recipients.add("vm://service4?responseTransformers=validateResponse&exchange-pattern=request-response");
        recipients.add("vm://service5?responseTransformers=validateResponse&exchange-pattern=request-response");
        recipients.add("vm://service6?responseTransformers=validateResponse&exchange-pattern=request-response");
    ...
    public void testIllegalEndpoint() throws Exception
    {
        ...
        Map<String, Object> props = new HashMap<String, Object>();
        List<String> recipients = new ArrayList<String>();
        recipients.add("vm://service998?exchange-pattern=request-response");
        recipients.add("vm://service5?exchange-pattern=request-response");
