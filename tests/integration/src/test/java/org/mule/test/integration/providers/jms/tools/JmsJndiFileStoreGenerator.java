...
public class JmsJndiFileStoreGenerator
{
    ...
    {
        //To use this you need to uncomment the method you wish to use and the imports
        try
        {
...
//
//        QueueConnectionFactory qcf = (QueueConnectionFactory)init.lookup("JmsQueueConnectionFactory");
//        TopicConnectionFactory tcf = (TopicConnectionFactory)init.lookup("JmsTopicConnectionFactory");
//
//        //Note XA support is not yet fully implemented in OpenJms
//        //XAQueueConnectionFactory xaqcf = (XAQueueConnectionFactory)init.lookup("XAJmsQueueConnectionFactory");
//        //XATopicConnectionFactory xatcf = (XATopicConnectionFactory)init.lookup("XAJmsTopicConnectionFactory");
//
//        ctx.bind("JmsQueueConnectionFactory", qcf);
//        ctx.bind("JmsTopicConnectionFactory", tcf);
//        //ctx.bind("XAJmsQueueConnectionFactory", xaqcf);
...
//        props.load(new FileInputStream("src/providers/jms/src/test/conf/activemq-jndi-connection.properties"));
...
//            xacf = new ActiveMQXAConnectionFactory(brokerUlr, username, password);
//        } else {
...
//        ctx.close();
    ...
    {
//        Properties props = new Properties();
//        props.load(new FileInputStream("src/providers/jms/src/test/conf/spiritwave-jndi-connection.properties"));
//        Context ctx = getFileContext("wave");
//
//        WaveQueueConnectionFactory qcf = new WaveQueueConnectionFactory(props);
//        WaveTopicConnectionFactory tcf = new WaveTopicConnectionFactory(props);
//        WaveXAQueueConnectionFactory xaqcf = new WaveXAQueueConnectionFactory(props);
//        WaveXATopicConnectionFactory xatcf = new WaveXATopicConnectionFactory(props);
//
//        ctx.bind("JmsQueueConnectionFactory", qcf);
//        ctx.bind("JmsTopicConnectionFactory", tcf);
//        ctx.bind("XAJmsQueueConnectionFactory", xaqcf);
