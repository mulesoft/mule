...
public class TestXFireServiceUsingAxisEndpoint extends FunctionalTestCase{
	
	protected static transient Log logger = LogFactory.getLog(TestXFireServiceUsingAxisEndpoint.class);
