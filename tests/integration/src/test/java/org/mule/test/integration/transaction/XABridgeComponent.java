...
/**
 * Simple component that receives messages from jdbc or jms and just forward 
...
public class XABridgeComponent {
	...
	/**
	 * If <code>mayRollback</code> has been set to true,
	 * the component will mark the current transaction as rollback only
	 * on a 30 percent basis.
	 * @throws Exception
	 */
	...
	/**
	 * Receive the jdbc message and forward the <code>data</code> part.
	 * May mark the current transaction as rollback only.
	 * @param msg
	 * @return
	 * @throws Exception
	 */
