/*
 * $Id: ExpressionTransformerTestCase.java 17177 2010-05-05 12:55:17Z dirk.olmes $
 * --------------------------------------------------------------------------------------
...
public class ExceptionOutboundTestCase extends FunctionalTestCase
{
    ...
    {
        return "org/mule/test/integration/exceptions/exception-outbound.xml";
    }

    public void testExceptionStrategyHitted() throws Exception
    {
