...
public class TestAxisServiceUsingXFireEndpoint extends FunctionalTestCase{

	protected static transient Log logger = LogFactory.getLog(TestAxisServiceUsingXFireEndpoint.class);
	
	public TestAxisServiceUsingXFireEndpoint(){
		super();
