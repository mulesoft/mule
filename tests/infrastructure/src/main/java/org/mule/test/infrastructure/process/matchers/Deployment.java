...
public class Deployment extends TypeSafeMatcher<MuleProcessController>
{
    ...
    {
        description.appendText("a Mule Standalone server that successfully deployed: " + applicationName);
    }

    @Factory
    public static <T> Matcher<MuleProcessController> deployed(String applicationName)
    {
