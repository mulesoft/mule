...
public class MuleDeployment extends MuleInstallation {
  ...
  public static class Builder {
    ...
    /**
     * Configures the given {@code factoryClassName} as the {@link ProcessingStrategyFactory} to use
     *
     * @param factoryClassName the classname for a {@link ProcessingStrategyFactory} implementation
    ...
    /**
     * Configures the Proactor Processing strategy
     *
     * @return {@code this} builder
     * @since 4.3.0
     */
