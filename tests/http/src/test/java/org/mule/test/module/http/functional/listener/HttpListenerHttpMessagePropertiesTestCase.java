...
public class HttpListenerHttpMessagePropertiesTestCase extends AbstractHttpTestCase {
  ...
  public void xForwardedForHeader() throws Exception {
    ...
    final MuleMessage forwardedMessage = muleContext.getClient().request("test://out", RECEIVE_TIMEOUT).getRight().get();
  ...
  public HttpRequestAttributes getAttributes(MuleMessage message) {
