...
public class EndpointToEndpointXaTransactionTestCase extends FunctionalTestCase {
  ...
  public static Collection<Object[]> parameters() {
    ...
    return Arrays.asList(new Object[][] {{
        new String[] {"org/mule/test/integration/transaction/xa/xa-transaction-config.xml",
            "org/mule/test/integration/transaction/xa/vm-xa-transaction-config.xml", transactionManagerConfigFile},
  ...
  public void allCommit() {
    new TransactionScenarios(inboundMessagesCreator, outboundMessagesCounter).testNoFailureDuringFlowExecution();
  }

  @Test
  public void someRollbacksThenCommit() {
    new TransactionScenarios(inboundMessagesCreator, outboundMessagesCounter).testIntermittentFailureDuringFlowExecution();
  }

  @Test
  public void allRollbacks() {
    new TransactionScenarios(inboundMessagesCreator, outboundMessagesCounter).setVerificationTimeout(1000)
