...
@Sources({PetStoreSource.class, FailingPetStoreSource.class, SentientSource.class, PetAdoptionSource.class,
    PetAdoptionSchedulerInParamSource.class, PetStoreStreamSource.class, PetStoreListSource.class, PartialPetAdoptionSource.class,
    NumberPetAdoptionSource.class, ConnectedPetAdoptionSource.class, PetFailingPollingSource.class,
    WatermarkingPetAdoptionSource.class})
