...
public class PartialPetAdoptionSource extends PollingSource<String, Void> {

  public static final List<String> ALL_PETS =
      asList("Grumpy Cat", "Colonel Meow", "Silvester", "Lil bub", "Macri", "Pappo");
  ...
  public void poll(PollContext<String, Void> pollContext) {
    ...
    int petsToAdopt = min((timesPolled / POLLS_TO_ADD_PET) + 1, pets.size());

    pets.subList(0, petsToAdopt).stream()
