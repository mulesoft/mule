...
public class TestContentAndOutputWithAttributesResolverWithKeyResolver implements MetadataKeysResolver,
    MetadataContentResolver<String>, MetadataOutputResolver<String>, MetadataAttributesResolver<String> {
