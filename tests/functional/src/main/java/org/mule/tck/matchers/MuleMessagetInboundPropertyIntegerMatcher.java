...
public class MuleMessagetInboundPropertyIntegerMatcher extends TypeSafeMatcher<MuleMessage>
{
    ...
    public MuleMessagetInboundPropertyIntegerMatcher(String inboundPropertyNameGiven, Matcher<Integer> matcherGiven)
    {
    ...
    public boolean matchesSafely(MuleMessage message)
    {
        ...
        return inboundPropertyValue != null && matcher.matches(inboundPropertyValue);
    }
    ...
    protected void describeMismatchSafely(MuleMessage message, Description mismatchDescription)
    {
        ...
        if(inboundPropertyValue != null){
            mismatchDescription.appendValue(inboundPropertyValue);
        }
        else
        {
    ...
    @Factory
    public static Matcher<MuleMessage> inboundProperty(String inboundPropertyName, Matcher<Integer> matcher)
    {
        return new MuleMessagetInboundPropertyIntegerMatcher(inboundPropertyName, matcher);
    }
}
