...
public class MuleMessagePayloadStringMatcher extends TypeSafeMatcher<MuleMessage>
{

    private Matcher<String> matcher;
    private String payloadAsString = null;

    public MuleMessagePayloadStringMatcher(Matcher<String> matcherGiven)
    {
    ...
    @Factory
    public static Matcher<MuleMessage> payloadAsString(Matcher<String> matcher)
    {
        return new MuleMessagePayloadStringMatcher(matcher);
