 ...
 * <p/>
 * A private static method should be defined and annotated with this annotation in order to be called by the runner
 * so the test later could get access to the plugins {@link ClassLoader}. Only one method should be annotated with this annotation.
 * <p/>
