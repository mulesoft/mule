...
/**
 * Uses maven <a href="https://github.com/ferstl/depgraph-maven-plugin">https://github.com/ferstl/depgraph-maven-plugin</a> to resolve the dependencies for current artifact.
 * It relies on the {@link DependencyGraphMavenDependenciesResolver#DEPENDENCIES_GRAPH_FILE_NAME} DOT (a plain text graph description language) file generated by the
 * depgraph-maven-plugin and the artifact should have set this plugin in its maven build section before this code is executed.
 * <p/>
