 ...
 * Useful for running applications or tests in a lightweight environment with isolation.
 * <p/>
 * The builder could be set with different extension points:
 * <ul>
 * <li>{@link ClassPathUrlProvider}: defines the initial classpath to be classified, it consists in a {@link List} of {@link java.net.URL}'s</li>
 * <li>{@link ClassPathClassifier}: classifies the classpath URLs and builds the {@link List} or {@link java.net.URL}s for each {@link ClassLoader}</li>
 * <li>{@link MavenDependenciesResolver}: builds the dependency graph used by the classification in order to get the dependencies for the different Maven artifacts</li>
 ...
 * <p/>
 * The object built by this builder is a {@link ArtifactClassLoaderHolder} that references the {@link org.mule.runtime.module.artifact.classloader.ArtifactClassLoader} for
 * the application, plugins and container.
 *
 * @since 4.0
 */
public class ArtifactIsolatedClassLoaderBuilder
{
    ...
    /**
     * Builds the {@link ArtifactClassLoaderHolder} with the {@link org.mule.runtime.module.artifact.classloader.ArtifactClassLoader}s for
    ...
    public ArtifactClassLoaderHolder build()
    {
        ...
        try
        {
            context = new ClassPathClassifierContext(rootArtifactClassesFolder, rootArtifactTestClassesFolder, classPathUrlProvider.getURLs(),
