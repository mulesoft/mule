...
public class MVELBenchmarkAssertionTestCase extends AbstractBenchmarkAssertionTestCase
{
    ...
    {
        runAndAssertBenchmark(MVELDeepAssignBenchmark.class, "mvelColdStart", 4000, MICROSECONDS);
    }
    ...
    {
        runAndAssertBenchmark(MVELDeepInvokeBenchmark.class, "mvelColdStart", 1000, MICROSECONDS);
    }
