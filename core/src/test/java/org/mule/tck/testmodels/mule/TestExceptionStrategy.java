...
public class TestExceptionStrategy extends AbstractExceptionStrategy implements MessagingExceptionHandler, SystemExceptionHandler
{
    ...
    public MuleEvent handleException(Exception exception, MuleEvent event, UndoActionCallback rollbackMethod)
    {
    ...
    public void handleException(Exception exception, UndoActionCallback rollbackMethod)
    {
