...
public abstract class SerializationTestUtils
{
    ...
    public static MuleContext addJavaSerializerToMockMuleContext(MuleContext mockMuleContext)
    {
        when(mockMuleContext.getObjectSerializer()).thenReturn(getJavaSerializer(mockMuleContext));
