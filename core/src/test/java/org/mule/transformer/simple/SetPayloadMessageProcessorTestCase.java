...
public class SetPayloadMessageProcessorTestCase extends AbstractMuleTestCase
{
    ...
    public void setUp()
    {
        ...
        Mockito.when(expressionManager.parse(anyString(), Mockito.any(MuleMessage.class))).thenAnswer(
                new Answer<String>()
                {
                    @Override
    ...
    @Test
    public void setsDataTypeForNullPayload() throws MuleException
    {
        setPayloadMessageProcessor.setValue(null);
        setPayloadMessageProcessor.initialise();
    ...
    @Test
    public void setsDataTypeNonNullValue() throws MuleException
    {
        setPayloadMessageProcessor.setValue(PLAIN_TEXT);
        setPayloadMessageProcessor.initialise();
    ...
    {
        setPayloadMessageProcessor.setValue(null);
        setPayloadMessageProcessor.setReturnClass(Long.class);
        setPayloadMessageProcessor.initialise();
