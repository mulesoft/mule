...
public class SetPayloadMessageProcessorTestCase extends AbstractMuleTestCase
{
    ...
    @Test
    public void setsCustomTypeForNullPayload() throws MuleException
    {
        setPayloadMessageProcessor.setValue(null);
        setPayloadMessageProcessor.setReturnClass("java.lang.Long");
        setPayloadMessageProcessor.initialise();
        ...
        assertThat(actualDataType.getValue(), DataTypeMatcher.like(Long.class, MimeTypes.ANY, null));
    }

    @Test
    public void setsCustomTypeNonNullValue() throws MuleException
    {
        setPayloadMessageProcessor.setValue(PLAIN_TEXT);
        setPayloadMessageProcessor.setReturnClass("java.lang.Long");
        setPayloadMessageProcessor.initialise();
    ...
    @Test
    public void setsCustomTypeFromExpression() throws MuleException
    {
        setPayloadMessageProcessor.setValue(PLAIN_TEXT);
        setPayloadMessageProcessor.setReturnClass(CLASS_NAME_EXPRESSION);
        setPayloadMessageProcessor.initialise();

        when(expressionManager.isExpression(CLASS_NAME_EXPRESSION)).thenReturn(true);
        when(expressionManager.evaluate(CLASS_NAME_EXPRESSION, muleEvent)).thenReturn(Long.class.getCanonicalName());
