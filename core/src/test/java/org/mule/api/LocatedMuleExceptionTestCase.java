...
public class LocatedMuleExceptionTestCase extends AbstractMuleContextTestCase
{
    ...
    public void namedComponent()
    {
        ...
        assertThat(lme.getInfo().get(LocatedMuleException.INFO_LOCATION_KEY).toString(), is("/mockComponent"));
    }
    ...
    public void annotatedComponent()
    {
        ...
        assertThat(lme.getInfo().get(LocatedMuleException.INFO_LOCATION_KEY).toString(), is("Mock@1 (Mock Component)"));
    }
    ...
    public void namedAnnotatedComponent()
    {
        ...
        assertThat(lme.getInfo().get(LocatedMuleException.INFO_LOCATION_KEY).toString(), is("/mockComponent (Mock Component)"));
    }
    ...
    public void rawComponent()
    {
        ...
        assertThat(lme.getInfo().get(LocatedMuleException.INFO_LOCATION_KEY).toString(), is("Mock@1"));
    }
}
