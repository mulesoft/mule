...
public class MuleEventTestCase extends AbstractMuleContextTestCase
{
    ...
    final String FLOW_DIFFERENT_KEY = "aFlowVarName";

    final String FLOW_VALUE = "aFlowVarValue";

    final String FLOW_DIFFERENT_VALUE = "aDifferentFlowVarValue";

    final String SESSION_KEY = "aFlowVarName";

    final String SESSION_VALUE = "aFlowVarValue";

    final String SESSION_DIFFERENT_VALUE = "aDifferentFlowVarValue";
