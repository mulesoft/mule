...
import static org.mule.util.queue.TransactionalQueueManager.MAX_TRANSACTION_LOG_FILE_SIZE;
...
public class LocalTxQueueTransactionJournalTestCase extends AbstractMuleContextTestCase
{
    ...
    {
        MuleTestUtils.testWithSystemProperty(MAX_TRANSACTION_LOG_FILE_SIZE, "1", new MuleTestUtils.TestCallback()
        {
            @Override
