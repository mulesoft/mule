...
public class MuleObjectStoreManagerTestCase extends AbstractMuleTestCase
{
    ...
    private ObjectStorePartition<Serializable> createStorePartition(String partitionName, boolean isPersistent) throws InitialisationException
    {
        ...
        ObjectStorePartition<Serializable> store = storeManager
                .getObjectStore(partitionName, isPersistent, 100, 10000, 50);
    ...
    private PartitionableObjectStore<? extends Serializable> createTransientPartitionableObjectStore()
    {
        return new PartitionedInMemoryObjectStore<Serializable>();
    }

    private PartitionableObjectStore<? extends Serializable> createPersistentPartitionableObjectStore(MuleContext muleContext)
    {
