...
import static org.mule.util.xmlsecurity.DefaultXMLSecureFactories.configureSchemaFactory;
import static org.mule.util.xmlsecurity.DefaultXMLSecureFactories.configureTransformerFactory;
import static org.mule.util.xmlsecurity.DefaultXMLSecureFactories.configureValidator;
...
public class XMLSecureFactoriesPropertiesTestCase extends AbstractMuleTestCase
{
    ...
    public void validatorProperties() throws Exception
    {
        ...
        configureValidator(false, false, validatorWrapper);
    ...
    public void schemaFactoryProperties() throws Exception
    {
        ...
        configureSchemaFactory(false, false, schemaFactoryWrapper);
        assertThat(setPropertyAnswer.exception, is(nullValue()));
    ...
    public void transformerFactoryProperties()
    {
        ...
        configureTransformerFactory(false, false, transformerFactoryWrapper);
        assertThat(setPropertyAnswer.exception, is(nullValue()));
