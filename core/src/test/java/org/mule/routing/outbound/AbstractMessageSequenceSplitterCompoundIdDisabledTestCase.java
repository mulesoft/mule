...
public class AbstractMessageSequenceSplitterCompoundIdDisabledTestCase {

  @ClassRule
  public static SystemProperty compoundCorrelationIdDisable = new SystemProperty(MuleProperties.MULE_DISABLE_COMPOUND_CORRELATION_ID, "true");
  ...
  @Test
  public void testSetMessageCorrelationIdIsSequentialSetsMessageCorrelationIdWithSequencePrefix_WhenCompoundCorrelationIdIsDisabled(){
    //Given
    isSequential = true;
    ...
    //Then
    assertThat("Correlation Id is not as expected", message.getCorrelationId(), is(correlationId + "-" + correlationSequence));
  }

  @Test
  public void testSetMessageCorrelationIdIsNotSequentialSetsMessageCorrelationIdAsIs_WhenCompoundCorrelationIdIsDisabled(){
    //Given
    isSequential = false;
    String correlationId = "Jack";
    int correlationSequence = 1;
