...
public class DynamicOutboundEndpoint extends DynamicURIOutboundEndpoint
{
    ...
    protected static class NullOutboundEndpoint extends AbstractEndpoint implements OutboundEndpoint
    {
        ...
        {
            super(createDynamicConnector(muleContext), null, null, new HashMap(), null, null, true, null, MessageExchangePattern.ONE_WAY, 0, "started", null, null, muleContext, null, null, null, null, true, null);
        }
