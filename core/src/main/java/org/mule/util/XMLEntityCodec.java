...
//     <!-- rsaquo is proposed but not yet ISO standardized -->
         ...
         * 
         * @param str The <code>String</code> to escape.
         * @return A new escaped <code>String</code> or str itself if no unescaping
         *         was necessary.
         */
         ...
         * </p>
         * 
         * @param writer The <code>Writer</code> to write the results to; assumed
         *            to be non-null.
         * @param string The <code>String</code> to write the results to; assumed
         *            to be non-null.
         * @throws IOException when <code>Writer</code> passed throws the exception
         *             from calls to the {@link Writer#write(int)} methods.
         * @see #escape(String)
        ...
        private static class IntHashMap
        {
             ...
             * factor, which is <code>20</code> and <code>0.75</code>
             * respectively.
             * </p>
             */
            public IntHashMap()
             ...
             *         by the <tt>equals</tt> method; <code>false</code>
             *         otherwise.
