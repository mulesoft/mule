...
public class ClassUtils extends org.apache.commons.lang.ClassUtils
{
    ...
    /**
     * Checks that {@code value} is an instance of {@code type}. The value
     * that this method adds over something like {@link Class#isInstance(Object)}
     ...
     * is the wrapper or which is the primitive. For example, this method will return {@code true} for both
     * the {@link Double}/{@code double} and the {@code double}/{@link Double} pairs. Notice that
     * {@code false} will be returned for the pair {@link Long}/{code int} since they don't represent
     * the same data type.
     * <p/>
     ...
     * @return {@code true} if the types are a wrapper/primitive pair referring to the same data type. {@code} otherwise.
     */
    public static boolean isWrapperAndPrimitivePair(Class<?> type1, Class<?> type2)
    {
     ...
     */
    public static <T> boolean isPrimitiveWrapper(Class<T> type)
    {
