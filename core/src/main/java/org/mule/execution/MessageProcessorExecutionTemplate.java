...
public class MessageProcessorExecutionTemplate
{
    ...
    public static MessageProcessorExecutionTemplate createExecutionTemplate(ServerNotificationHandler serverNotificationHandler)
    {
        return new MessageProcessorExecutionTemplate(new MessageProcessorNotificationExecutionInterceptor(serverNotificationHandler,
                new ExceptionToMessagingExceptionExecutionInterceptor()));
    }
