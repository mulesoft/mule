 ...
 * @since 4.0
 */
public interface OperationPolicy extends Serializable {
   ...
   * @throws Exception
   */
  Event process(Event event, NextOperation nextOperation, OperationParametersProcessor operationParametersProcessor)
      throws Exception;
