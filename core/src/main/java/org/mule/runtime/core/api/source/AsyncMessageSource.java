...
/**
 * Implemented by sources that receive or generate messages which are to be processed by a {@link AsyncProcessor}. This source
 * interface extends {@link MessageSource} for compatibility and it is up to implementations to determine if they use the
 * injection {@link Processor}, {@link AsyncProcessor} or both.
 *
