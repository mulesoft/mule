...
/**
 * Representation of a failure during processing of a {@link CoreEvent}, associates both failure and event taking into account
 * {@link TypedException} instances.
 *
 * @since 4.0
 */
public class EventProcessingException extends MuleException {

  private static final long serialVersionUID = -5726630241600130610L;
