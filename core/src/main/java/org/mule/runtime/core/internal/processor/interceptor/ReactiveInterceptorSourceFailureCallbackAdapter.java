 ...
 * @since 4.2.3
 */
public class ReactiveInterceptorSourceFailureCallbackAdapter
    extends AbstractReactiveInterceptorSourceCallbackAdapter<SourcePolicyFailureResult> {

  public ReactiveInterceptorSourceFailureCallbackAdapter(SourceInterceptorFactory interceptorFactory) {
