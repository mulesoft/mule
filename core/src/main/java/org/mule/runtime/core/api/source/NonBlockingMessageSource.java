...
/**
 * NonBlockingMessageSource's create instances of MuleEvent that contain a {@link org.mule.api.connector.ReplyToHandler}
 ...
 * {@link org.mule.api.connector.ReplyToHandler} to be invoked before sending a response, otherwise the response should be
 * sent immediatly.
 * <p/>
