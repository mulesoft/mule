...
public final class DefaultRouterResultsHandler implements RouterResultsHandler {
  ...
  /**
   * Aggregates the events in the results list into one single {@link CoreEvent} You should only use this method when you're sure
   * that all the events in the results list were generated by the same thread that's going to handle the aggregated response
   *
   * @param results
   * @param previous
   * @return
