...
public interface FlowsSummaryStatistics extends Statistics {
  ...
  /**
   * Increments the counter of private flows declared in the application.
   *
   * @return The updated number of declared private flows
   */
  int incrementDeclaredPrivateFlow();

  /**
   * Increments the counter of private flows active in the application.
   *
   * @return The updated number of active private flows
   */
  int incrementActivePrivateFlow();

  /**
   * Increments the counter of trigger flows declared in the application.
   *
   * @return The updated number of declared trigger flows
   */
  int incrementDeclaredTriggerFlow();

  /**
   * Increments the counter of trigger flows active in the application.
   *
   * @return The updated number of declared private flows
   */
  int incrementActiveTriggerFlow();

  /**
   * Decrements the counter of private flows declared in the application.
   *
   * @return The updated number of declared private flows
   */
  int decrementDeclaredPrivateFlow();

  /**
   * Decrements the counter of private flows active in the application.
   *
   * @return The updated number of active private flows
   */
  int decrementActivePrivateFlow();

  /**
   * Decrements the counter of trigger flows declared in the application.
   *
   * @return The updated number of declared trigger flows
   */
  int decrementDeclaredTriggerFlow();

  /**
   * Decrements the counter of trigger flows active in the application.
   *
   * @return The updated number of declared private flows
   */
  int decrementActiveTriggerFlow();
