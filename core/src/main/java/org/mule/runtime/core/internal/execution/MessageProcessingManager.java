...
public interface MessageProcessingManager {
   ...
   *        the {@link MessageSource} can apply custom logic during message processing. The message will participate only on those
   *        phases were the template defines the required template methods
