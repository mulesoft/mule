...
public interface CustomizationService
{
    ...
    /**
     * Allows to override a service provided by default on a mule context. The provided implementation
    ...
    /**
     * Allows to override a service provided by default on a mule context. The provided class will be used
     * to instantiate the service that replaces the default one if it's replacing an existent service.
     * <p>
    ...
    /**
     * Allows to define a custom service on a mule context. The provided class will be used
     * to instantiate the service that replaces the default one if it's replacing an existent service.
     * <p>
     * The service class can be annotated with {@link javax.inject.Inject} and implement methods from
     * {@link  org.mule.runtime.core.api.lifecycle.Lifecycle}.
