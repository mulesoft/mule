...
public interface ByteBufferManager {
   ...
   * <p>
   * Invokers <b>MUST</b> call the {@link ManagedByteBufferWrapper#deallocate()} method on the returned
   ...
   * @deprecated since 4.3.0. Use {@link ManagedByteBufferWrapper#deallocate()} instead
   */
  @Deprecated
