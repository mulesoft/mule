...
public class ComponentExecutionProfilingEventContextWithThreadProfiling implements ComponentExecutionProfilingEventContext {
    ...
    public ComponentExecutionProfilingEventContextWithThreadProfiling(ComponentExecutionProfilingEventContext delegate, OperationThreadSnapshot threadSnapshot) {
