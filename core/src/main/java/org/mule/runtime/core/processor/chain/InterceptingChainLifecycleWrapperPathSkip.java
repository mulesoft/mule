...
/**
 * When adding path elements to the {@link Processor}s, the chains add a level to this path. For some MessageProcessors
 * this is the desired case, like {@link org.mule.runtime.core.routing.ChoiceRouter}, but for others this is undesired behaviour.
 * Use only if it is necessary to avoid adding a level into the path elements. TODO MULE-10418
 */
