...
public class MuleProperties {
  ...
  public static final String MULE_ACTIVATE_SCHEDULERS_LATENCY_REPORT = SYSTEM_PROPERTY_PREFIX + "schedulers.latency.report";
  public static final String MULE_DEFAULT_LOGGING_INTERVAL_SCHEDULERS_LATENCY_REPORT =
