...
/**
 * Processes a {@link Event} by invoking the next {@link Processor} but receiving the reply, which is turn is returned from
 * this MessageProcessor from a seperate {@link MessageSource} rather than using the return value of the <code>next</code>
