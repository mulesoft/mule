...
public class SubflowInterceptingChainLifecycleWrapper extends InterceptingChainLifecycleWrapper
  ...
  public SubflowInterceptingChainLifecycleWrapper(DefaultMessageProcessorChain chain, List<Processor> processors,
                                                  String name) {
  ...
  public void addMessageProcessorPathElements(MessageProcessorPathElement pathElement) {
    ...
    List<Processor> filteredMessageProcessorList = new ArrayList<>();
