...
import static org.mule.runtime.core.api.config.MuleProperties.MULE_DIAGNOSTICS_SERVICE_KEY;
...
public class DefaultsConfigurationBuilder extends AbstractConfigurationBuilder {
  ...
  protected void doConfigure(MuleContext muleContext) throws Exception {
    ...
    registerObject(MULE_DIAGNOSTICS_SERVICE_KEY, new DefaultDiagnosticsService(), muleContext);
