...
/**
 * Hooks the {@link SourceInterceptor}s for a {@link MessageSource} success callback into the {@code Reactor} response handling
 * pipeline.
 *
 * @since 4.2.3
 */
public class ReactiveInterceptorSourceSuccessCallbackAdapter
    extends AbstractReactiveInterceptorSourceCallbackAdapter<SourcePolicySuccessResult> {


  public ReactiveInterceptorSourceSuccessCallbackAdapter(SourceInterceptorFactory interceptorFactory) {
