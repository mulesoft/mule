...
import org.mule.runtime.core.api.tracing.customization.NoExportTillExecuteNextComponentEventBasedStartSpanInfoProvider;
  ...
  public final void initialise() throws InitialisationException {
    processorChain =
        buildNewChainWithListOfProcessors(ofNullable(processingStrategy), processors, policyChainErrorHandler(),
                                          new NoExportTillExecuteNextComponentEventBasedStartSpanInfoProvider(this));
