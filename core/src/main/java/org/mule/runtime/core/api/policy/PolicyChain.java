...
import org.mule.runtime.core.api.tracing.customization.NoExportableTillExecuteNextComponentCoreEventStartSpanInfoProvider;
  ...
  public final void initialise() throws InitialisationException {
    processorChain =
        buildNewChainWithListOfProcessors(ofNullable(processingStrategy), processors, policyChainErrorHandler(),
                                          new NoExportableTillExecuteNextComponentCoreEventStartSpanInfoProvider(this));
