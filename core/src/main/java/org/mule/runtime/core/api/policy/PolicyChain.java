...
import org.mule.runtime.core.api.tracing.customization.NoExportTillExecuteNextComponentStartSpanInfoProvider;
  ...
  public final void initialise() throws InitialisationException {
    processorChain =
        buildNewChainWithListOfProcessors(ofNullable(processingStrategy), processors, policyChainErrorHandler(),
                                          new NoExportTillExecuteNextComponentStartSpanInfoProvider(this));
