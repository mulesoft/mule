...
import org.mule.runtime.core.api.tracing.customization.NoExportTillExecuteNextComponentCoreInfoProviderStart;
  ...
  public final void initialise() throws InitialisationException {
    processorChain =
        buildNewChainWithListOfProcessors(ofNullable(processingStrategy), processors, policyChainErrorHandler(),
                                          new NoExportTillExecuteNextComponentCoreInfoProviderStart(this));
