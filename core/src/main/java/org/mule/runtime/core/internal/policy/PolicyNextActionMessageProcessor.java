...
public class PolicyNextActionMessageProcessor extends AbstractComponent implements Processor, Initialisable, Disposable {
  ...
  public final CoreEventStartSpanInfoProvider NO_EXPORT_CHILD_NAMED_SPAN_BASED_ON_PARENT_SPAN_CHILD_SPAN_CUSTOMIZATION_INFO =
      new NoExportableComponentCoreEventStartSpanInfoProvider(this);
