...
public class EventToMessageSequenceSplittingStrategy implements SplittingStrategy<BaseEvent, MessageSequence<?>> {
  ...
  public MessageSequence<?> split(BaseEvent event) {
