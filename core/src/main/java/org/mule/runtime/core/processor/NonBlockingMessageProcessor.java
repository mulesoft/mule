 ...
 *
 * If the current {@link org.mule.runtime.core.api.Event} is not synchronous and a
 ...
 *
 * Alternatively if the {@link org.mule.runtime.core.api.Event} is synchronous, then the response should be returned and the
 * {@link org.mule.runtime.core.api.connector.ReplyToHandler} not used.
 *
 * @since 3.7
 */
public interface NonBlockingMessageProcessor extends Processor, NonBlockingSupported {
