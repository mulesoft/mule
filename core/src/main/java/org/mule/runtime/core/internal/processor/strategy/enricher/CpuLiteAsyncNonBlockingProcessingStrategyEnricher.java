...
import static org.mule.runtime.core.internal.processor.strategy.reactor.builder.ComponentProcessingStrategyReactiveProcessorBuilder.buildProcessorChainFrom;
...
public class CpuLiteAsyncNonBlockingProcessingStrategyEnricher implements ReactiveProcessorEnricher {
  ...
  public ReactiveProcessor enrich(ReactiveProcessor processor) {
    return buildProcessorChainFrom(processor, liteSchedulerSupplier.get())
