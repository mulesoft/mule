...
public class AttributeEvaluator
{
    ...
    public TypedValue resolveTypedValue(MuleEvent event)
    {
        ...
        else if (isParseExpression())
        {
            ...
            return new TypedValue(value, DataType.builder(String.class).mimeType((String) null).build());
        }
        else
        {
            Class<?> type = attributeValue == null ? Object.class : String.class;
            return new TypedValue(attributeValue, DataType.builder(type).mimeType((String) null).build());
        }
    }
