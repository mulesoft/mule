...
public class CollectAllAggregationStrategy implements AggregationStrategy {
  ...
  @Override
  public InternalEvent aggregate(AggregationContext context) throws MuleException {
  ...
  protected InternalEvent aggregateWithoutFailedRoutes(AggregationContext context) throws MuleException {
