...
/**
 * A condition that has to be meet when a tracing operation is done.
 *
 * @since 4.5.0
 */
public interface TracingCondition {
  ...
  /**
   * Assertion to perform on the current span. If the current span when the operation is perform does not meet certain conditions
