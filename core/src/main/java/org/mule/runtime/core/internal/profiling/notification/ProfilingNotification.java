...
public class ProfilingNotification<T extends ProfilingEventContext> extends AbstractServerNotification {
  ...
  private static final int COMPONENT_THREAD_RELEASE_ID = PROFILING_ACTION_START_RANGE + 10;
  ...
  static {
    ...
    registerAction(getFullyQualifiedProfilingNotificationIdentifier(COMPONENT_THREAD_RELEASE), COMPONENT_THREAD_RELEASE_ID);
  }
