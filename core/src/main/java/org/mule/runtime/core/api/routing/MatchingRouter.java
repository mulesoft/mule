 ...
 * implementations of this interface which use the {@link Matchable#isMatch(org.mule.runtime.core.api.MuleMessage)} method of the
 * routers to determine if a router accept the event or not.
 * <p>
