...
/**
 * A factory interface for managing the lifecycles of a transport's message requesters. The methods basically implement
 * the {@link org.apache.commons.pool.KeyedPoolableObjectFactory} lifecycle, with a
 * {@link org.mule.runtime.core.api.endpoint.InboundEndpoint} as the key and the requester as pooled object.
 * 
...
public interface MessageRequesterFactory
{
     ...
     * {@link #validate(org.mule.runtime.core.api.endpoint.InboundEndpoint, org.mule.runtime.core.api.transport.MessageRequester)} it takes
     * precedence over the dispatcher's own return value of
     * {@link org.mule.runtime.core.api.transport.MessageDispatcher#validate()}.
     *
     ...
     * client, but <strong>not</strong> after {@link #create(org.mule.runtime.core.api.endpoint.InboundEndpoint)}.
     *
     ...
     * {@link #passivate(org.mule.runtime.core.api.endpoint.InboundEndpoint, org.mule.runtime.core.api.transport.MessageRequester)}.
     *
     * @param endpoint the endpoint of the requester
     ...
     * {@link #validate(org.mule.runtime.core.api.endpoint.InboundEndpoint, org.mule.runtime.core.api.transport.MessageRequester)}.
     *
     * @param endpoint the endpoint of the requester
     * @param requester the requester to be validated
     */
