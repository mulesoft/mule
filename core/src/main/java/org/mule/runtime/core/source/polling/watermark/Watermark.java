...
public abstract class Watermark extends MessageProcessorPollingOverride {
  ...
  /**
   * The default expression to update the flow variable in case it is not in the object store or it fails to retrieve it.
   */
  private final String defaultExpression;

  /**
   * The object store instance. The default value is the persistent user object store.
   */
