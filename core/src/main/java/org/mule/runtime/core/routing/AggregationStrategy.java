...
/**
 * Strategy pattern for aggregating a list of {@link MuleEvent} passed through a {@link AggregationContext} into a single one
 * 
 * @since 3.5.0
 */
public interface AggregationStrategy {
   ...
   * @return a resulting {@link MuleEvent}. It can be a new event, an enriched version of
