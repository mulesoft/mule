 ...
 * </p>
 */
public abstract class AbstractCompositeMessageProcessorBuilder implements MessageProcessorBuilder
{
    ...
    public AbstractCompositeMessageProcessorBuilder()
    {
        // empty
    }

    public AbstractCompositeMessageProcessorBuilder(FlowConstruct flowConstruct)
    {
