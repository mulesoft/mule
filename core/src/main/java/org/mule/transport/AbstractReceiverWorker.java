...
public abstract class AbstractReceiverWorker implements Work
{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractReceiverWorker.class);
                        ...
                        resultEvent = perMessageExecutionTemplate.execute(new ExecutionCallback<MuleEvent>()
                        {
                            ...
                            public MuleEvent process() throws Exception
                            {
                                ...
                                if (preProcessedPayload != null)
                                {
                                    ...
                                    } catch (MuleException | RuntimeException e) {
                                    	session = null;
                                    	LOGGER.error("Ignore invalid session information in message due to " + e);
