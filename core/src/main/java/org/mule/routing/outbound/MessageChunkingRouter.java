...
public class MessageChunkingRouter extends FilteringOutboundRouter
{
    ...
    public MuleEvent route(MuleEvent event) throws RoutingException
    {
        ...
        else if (messageSize > 0)
        {
            ...
            {
                throw new RoutingException(CoreMessages.failedToReadPayload(), message, getTarget(0,
                    message), e);
            }
            ...
            catch (RoutingException e)
            {
                ...
                e = new RoutingException(e.getI18nMessage(), e.getMuleMessage(), e.getTarget(), e.getCause());
