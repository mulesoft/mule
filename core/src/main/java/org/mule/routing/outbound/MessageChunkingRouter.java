...
/**
 * A router that breaks up the current message onto smaller parts and sends them
 * to the same destination. The Destination component needs to have a
 * MessageChunkingAggregator inbound router in order to rebuild the message at the other end.
 *
