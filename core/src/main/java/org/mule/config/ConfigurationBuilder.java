 ...
 * UMOManager instance using different configuration mechanisms, such as for
 * Xml, a script or some other means.
 *
...
public interface ConfigurationBuilder
{
     ...
     *          This is useful for managing different environments (dev, test, production)
     * @return A configured UMOManager
     * @throws ConfigurationException
     */
     ...
     * through Readers
     *
     * @param configResources - An array of Readers, each Reader contains a portion of
     *                          the Mule server configuration.
     * @param startupProperties - Optional properties to be set before configuring the
     *          Mule server.  This is useful for managing different environments (dev, test, production)
     * @return A configured UMOManager
     * @throws ConfigurationException
     */
    UMOManager configure(ReaderResource[] configResources, Properties startupProperties) throws ConfigurationException;
