...
public final class ExceptionHelper
{
    ...
    private static int exceptionThreshold = 3;
    ...
    public static String getExceptionStack(Throwable t)
    {
        ...
        ExceptionReader er = getExceptionReader(rootMule);
        buf.append(er.getMessage(rootMule)).append(" (")
        ...
        if(verbose)
        {
            ...
            {
                if (processedMuleElements > exceptionThreshold && exceptionThreshold > 0)
                {
                    break;
                }
