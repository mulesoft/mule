...
public class ConstantThreadingProfile implements ThreadingProfile
{
    ...
    public ConstantThreadingProfile(int maxThreadsActive,
                            int maxThreadsIdle,
                            int maxBufferSize,
                            long threadTTL,
    ...
    public ConstantThreadingProfile(ThreadingProfile tp)
    {
