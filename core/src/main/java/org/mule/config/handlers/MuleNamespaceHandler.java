...
import org.mule.config.parsers.ConfigurationDefinitionParser;
import org.mule.config.parsers.ConnectionStrategyDefinitionParser;
import org.mule.config.parsers.CustomElementDefinitionParser;
import org.mule.config.parsers.EndpointDefinitionParser;
import org.mule.config.parsers.EndpointRefDefinitionParser;
import org.mule.config.parsers.FilterDefinitionParser;
import org.mule.config.parsers.InheritedModelDefinitionParser;
import org.mule.config.parsers.ModelDefinitionParser;
import org.mule.config.parsers.PropertiesDefinitionParser;
import org.mule.config.parsers.RouterDefinitionParser;
import org.mule.config.parsers.ServiceDescriptorDefinitionParser;
import org.mule.config.parsers.ServiceOverridesDefinitionParser;
import org.mule.config.parsers.SimpleChildDefinitionParser;
import org.mule.config.parsers.SingleElementDefinitionParser;
import org.mule.config.parsers.SourceTypeDefinitionParser;
import org.mule.config.parsers.ThreadingProfileDefinitionParser;
import org.mule.config.parsers.TransactionConfigDefinitionParser;
