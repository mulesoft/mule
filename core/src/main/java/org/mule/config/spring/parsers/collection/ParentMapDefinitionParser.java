 ...
 */
public class ParentMapDefinitionParser extends AbstractMuleSingleBeanDefinitionParser
{
    private Class mapClass;
    private String name;

    public ParentMapDefinitionParser(Class mapClass)
    {
        this.mapClass = mapClass;
    }

    public ParentMapDefinitionParser(Class mapClass, String name)
    {
        this.mapClass = mapClass;
        this.name = name;
    }
