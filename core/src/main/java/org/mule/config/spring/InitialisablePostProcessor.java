 ...
 */
public class InitialisablePostProcessor implements BeanPostProcessor, ApplicationContextAware
{
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException
    {
        if(bean instanceof Initialisable)
        {
            ...
            {
                throw new BeanCreationException("Failed to initialise object: " + bean.getClass().getName() + ":" + beanName, e);
            }
        }
        return bean;
    }
