...
import org.mule.config.spring.parsers.general.GrandchildDefinitionParser;
import org.mule.config.spring.parsers.general.InheritedModelDefinitionParser;
...
public class MuleNamespaceHandler extends AbstractIgnorableNamespaceHandler
{
    ...
    public void init()
    {
        ...
        registerBeanDefinitionParser("secret-key-encryption-strategy", new SimpleChildDefinitionParser("encryptionStrategies", SecretKeyEncryptionStrategy.class));
