...
import org.mule.config.spring.parsers.collection.MapBeanDefinitionParser;
import org.mule.config.spring.parsers.collection.PropertiesBeanDefinitionParser;
import org.mule.config.spring.parsers.generic.GrandchildDefinitionParser;
import org.mule.config.spring.parsers.generic.InheritedModelDefinitionParser;
import org.mule.config.spring.parsers.generic.ObjectFactoryDefinitionParser;
...
public class MuleNamespaceHandler extends AbstractIgnorableNamespaceHandler
{
    ...
    public void init()
    {
        ...
        registerBeanDefinitionParser("password-encryption-strategy", new SimpleChildDefinitionParser("encryptionStrategies", PasswordBasedEncryptionStrategy.class).withCollection("mule:password-encryption-strategy"));
        registerBeanDefinitionParser("secret-key-encryption-strategy", new SimpleChildDefinitionParser("encryptionStrategies", SecretKeyEncryptionStrategy.class).withCollection("mule:secret-key-encryption-strategy"));
