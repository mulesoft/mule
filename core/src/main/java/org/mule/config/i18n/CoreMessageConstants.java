...
public interface CoreMessageConstants
{
    ...
    int TOO_MANY_ACCEPTIBLE_METHODS_ON_X_FOR_TYPES_X = 60;
    ...
    int STREAMING_FAILED_FOR_ENDPOINT_X = 212;
    int STREAMING_ENDPOINTS_DONT_SUPPORT_TRANSFORMERS = 213;
    int STREAMING_ENDPOINTS_MUST_BE_USED_WITH_STREAMING_MODEL = 214;
    int SETTER_METHOD_FOR_BINDING_X_NOT_FOUND_ON_X = 215;
    int TOO_MANY_MATCHING_METHODS_WHICH_RETURN_X_ON_X = 216;
    int FAILED_TO_SET_PROXY_X_ON_SERVICE_X = 217;
    int MUST_SET_METHOD_NAMES_ON_BINDING = 218;
    int CANNOT_FINDE_BINDING_FOR_METHOD_X = 219;
    int NO_MATCHING_METHODS_WHICH_RETURN_X_ON_X = 220;
    int MORE_THAN_ONE_CONNECTOR_WITH_PROTOCOL_X = 221;
