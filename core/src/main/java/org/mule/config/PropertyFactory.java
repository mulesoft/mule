 ...
 * file.  PropertyFactories map to <factory-property> elements in the MuleXml config.
 *
 */
public interface PropertyFactory
{
     ...
     * @return an object that will become the value of a property with a name that matches
     * the 'name' attribute on the <factory-property> element.
     * @throws Exception
     */
