 ...
 * This adapter represents the 3 flows of data that Mule identifies, namely inbound, outbound and response flows.
 * These are represented by three streams on the
 * adapter.
 */
