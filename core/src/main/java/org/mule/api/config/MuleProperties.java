...
public class MuleProperties
{
    ...
    public static final String MULE_JMS_CLOSE_CONNECTION_ON_STOP=SYSTEM_PROPERTY_PREFIX + "jms.closeConnectionOnStop";
    ...
    //MULE-19941
    public static final String MULE_DISABLE_SET_VARIABLE_INHERITED_MIME_TYPE = SYSTEM_PROPERTY_PREFIX + "set-variable.inheritedMimeType.disable";
