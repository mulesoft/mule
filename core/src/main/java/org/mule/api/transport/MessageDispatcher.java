...
public interface MessageDispatcher extends Connectable, MessageDispatching
{
     ...
     * 
     * @see {@link MessageDispatcherFactory#activate(org.mule.api.endpoint.ImmutableEndpoint, MessageDispatcher)}
     */
    void activate();
     ...
     * 
     * @see {@link MessageDispatcherFactory#passivate(org.mule.api.endpoint.ImmutableEndpoint, MessageDispatcher)}
     */
    void passivate();
