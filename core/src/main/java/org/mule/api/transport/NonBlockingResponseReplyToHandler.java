...
public class NonBlockingResponseReplyToHandler implements ReplyToHandler
{
    ...
    private final MessageProcessorExecutionTemplate messageProcessorExecutionTemplate =
            MessageProcessorExecutionTemplate
            .createExecutionTemplate();
    private final LinkedList<MessageProcessor> responseProcessors = new LinkedList<MessageProcessor>();
    ...
    public void processReplyTo(MuleEvent event, MuleMessage returnMessage, Object replyTo) throws
                                                                                                        MuleException
    {
        ProcessorExecutor executor = new ReplyToNonBlockingProcessorExecutor(event, null, responseProcessors,
                                                                                     messageProcessorExecutionTemplate);
        try
        {
            executor.execute();
    ...
    {
        responseProcessors.addFirst(messageProcessor);
    }
