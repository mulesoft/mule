 ...
 * {@link org.mule.api.endpoint.ImmutableEndpoint} as the key and the requester as pooled object.
 */
public interface MessageRequesterFactory
{
     ...
     * {@link #validate(org.mule.api.endpoint.ImmutableEndpoint, org.mule.api.transport.MessageRequester)} it takes
     ...
     * client, but <strong>not</strong> after {@link #create(org.mule.api.endpoint.ImmutableEndpoint)}.
     *
     ...
     * {@link #passivate(org.mule.api.endpoint.ImmutableEndpoint, org.mule.api.transport.MessageRequester)}.
     *
     * @param endpoint the endpoint of the requester
     ...
     */
    boolean validate(ImmutableEndpoint endpoint, MessageRequester requester);
     ...
     */
    void passivate(ImmutableEndpoint endpoint, MessageRequester requester);

    /**
     * Invoked when a requester returned <code>false</code> for
     * {@link #validate(org.mule.api.endpoint.ImmutableEndpoint, org.mule.api.transport.MessageRequester)}.
     *
     * @param endpoint the endpoint of the requester
     * @param requester the requester to be validated
     */
    void destroy(ImmutableEndpoint endpoint, MessageRequester requester);
