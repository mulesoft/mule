...
public class ScanLicenseHeaders
{
    ...
    static List ignoredFiles = [ "BndMojo.java", "BobberArchetype.java", "BobberArchetypeMojo.java", "ClassReader.java",
        ...
        "__artifactId__IBean.java", "__artifactId__IBeanTestCase.java", "CronTriggerFactoryBean.java",
        "MethodInvokingJobDetailFactoryBean.java", "SchedulerAccessor.java", "SchedulerFactoryBean.java"];
