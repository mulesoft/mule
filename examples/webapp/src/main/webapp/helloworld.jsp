...
<tr><td>For more information about Hello world example go <a target="_blank" href="http://mule.mulesource.org/display/MULEINTRO/Hello+World+Example">here</a>.</td></tr>
</table>
</body>
</html>
