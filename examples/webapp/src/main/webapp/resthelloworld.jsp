...
processed.  This example uses the Servlet Connector in the <a target="_blank" href="http://www.mulesoft.org/documentation/display/MULE3USER/HTTP+Transport">Http Transport</a>.
<p/>
