...
<meta name="author" content="MuleSoft, Inc."></meta>
...
<br/>This example uses the Servlet Connector which is part of the <a target="_blank" href="http://www.mulesoft.org/documentation/display/MULE3USER/HTTP+Transport">Http Transport</a> to talk to Mule.
