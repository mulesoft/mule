...
IF '%Choice%'=='1' call %MULE_HOME%\bin\mule.bat -config .\conf\hello-config.xml
IF '%Choice%'=='2' call %MULE_HOME%\bin\mule.bat -config .\conf\hello-spring-config.xml -builder spring
IF '%Choice%'=='3' call %MULE_HOME%\bin\mule.bat -config .\conf\hello-http-config.xml
