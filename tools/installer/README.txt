...
1.) Put the individual Mule Distribution Files in the
...
3.) Set the IzPack_Home as an environment variable pointing to the location
    where your IzPack distribution is installed

4.) Add the MuleInstallerListener.jar and the provided MuleInstallerListener
...
7.) Build the Mule installer from the mule/tools/installer/config folder using
