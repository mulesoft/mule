 ...
 * a set of user parameters to create a working Maven project. This is a modified version for bobber to support additional functionality.
 * @requiresProject false
 */
public class BobberArchetypeMojo
