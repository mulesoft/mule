...
public class MuleGrapher
{
    ...
    protected void generateCombined(String filename) throws IOException, JDOMException
    {
        ...
        generateGraph(1, env.getConfig().getFiles(), env.getConfig().getOutputDirectory(), env
                        .getConfig().getCaption(), filename);
    }
    ...
    protected void generateIndividual() throws IOException, JDOMException
    {
        ...
        for (Iterator iterator = env.getConfig().getFiles().iterator(); iterator.hasNext();) {
            ...
            generateGraph(ind, list, env.getConfig().getOutputDirectory(), env.getConfig()
                            .getCaption(), new File(s).getName());
        }
    }
    ...
    public static void printUsage()
    {
        ...
        System.out.println("-----------------------------------------------");
        System.out
                        .println("-files      A comma-seperated list of Mule configuration files (required)");
        System.out
