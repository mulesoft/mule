...
public interface ColorRegistry
{
    ...
    // colors from http://www.graphviz.org/pub/scm/graphviz2/doc/info/colors.html

    String COLOR_DEFINED_ENDPOINTS = "lightblue";

    String COLOR_ROUTER = "darkolivegreen3";

    String COLOR_FILTER = "gold";
