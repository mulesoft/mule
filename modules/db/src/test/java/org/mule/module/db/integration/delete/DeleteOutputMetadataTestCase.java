...
public class DeleteOutputMetadataTestCase extends AbstractDbIntegrationTestCase
{

    public DeleteOutputMetadataTestCase(String dataSourceConfigResource, AbstractTestDatabase testDatabase)
    {
    ...
    {
        return new String[] {"integration/delete/delete-output-metadata-config.xml"};
    }

    @Test
    public void returnsDeleteOutputMetadata() throws Exception
    {
        Flow flowConstruct = (Flow) muleContext.getRegistry().lookupFlowConstruct("deleteOutputMetadata");
