...
public class OracleStoredProcedureXmlParamTestCase extends AbstractOracleXmlTypeTestCase
{
    ...
    public void returnsXmlTypeOutputParam() throws Exception
    {
        ...
        assertThat(mapPayload.containsKey(DESCRIPTION_FIELD), equalTo(true));
        assertThat(mapPayload.get(DESCRIPTION_FIELD).getClass().getName(), equalTo(XmlTypeUtils.ORACLE_XMLTYPE_CLASS));
    }
