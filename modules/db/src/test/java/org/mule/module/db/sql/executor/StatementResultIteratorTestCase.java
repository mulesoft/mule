...
import org.mule.module.db.result.resultset.NullResultSetHandler;
import org.mule.module.db.result.statement.OutputParamResult;
import org.mule.module.db.result.statement.ResultSetResult;
import org.mule.module.db.result.statement.StatementResultIterator;
import org.mule.module.db.result.statement.UpdateCountResult;
...
public class StatementResultIteratorTestCase extends AbstractMuleTestCase
{
    ...
    public void processOutputParamOnce() throws Exception
    {
        ...
        QueryTemplate queryTemplate = new QueryTemplate("dummy", QueryType.STORE_PROCEDURE_CALL, params);
        StatementResultIterator iterator = new StatementResultIterator(null, statement, queryTemplate, new NoAutoGeneratedKeyStrategy(), null);
