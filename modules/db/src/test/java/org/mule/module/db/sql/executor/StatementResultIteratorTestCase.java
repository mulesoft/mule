...
import static org.mule.module.db.internal.result.statement.StatementResultIterator.NO_UPDATE_COUNT;
...
public class StatementResultIteratorTestCase extends AbstractMuleTestCase
{
    ...
    public void setStatementResultIteratorHastNextReturnsFalseWhereThereIsNoMoreResultSets() throws SQLException {
        AutoGeneratedKeyStrategy autoGenerateKeysStrategy = new DefaultAutoGeneratedKeyStrategy();
        mockConnectionMetaData(true);
        ResultSet resultSet = mock(ResultSet.class);
        when(statement.getResultSet()).thenReturn(resultSet);
        ...
        when(resultSetHandler.processResultSet(connection, resultSet)).thenReturn(null);

        StatementResultIterator statementResultIterator =
                new StatementResultIterator(connection, statement, queryTemplate, autoGenerateKeysStrategy, resultSetHandler);
