...
public class DataSourceConfig implements MuleContextAware {
  ...
  public boolean isDynamic() {
    return isDynamicAttribute(url) || isDynamicAttribute(user) || isDynamicAttribute(password)
        || isDynamicAttribute(driverClassName);
  }
  ...
  private String resolveAttribute(String value, MuleEvent muleEvent) {
    return isDynamicAttribute(value) ? muleContext.getExpressionManager().parse(value, muleEvent, null) : value;
  }
