...
public class PreparedBulkUpdateProcessorBeanDefinitionParser extends AbstractSingleQueryProcessorDefinitionParser {
  ...
  protected BeanDefinition getParamResolverBeanDefinition() {
    BeanDefinitionBuilder sqlParamResolverFactory =
        BeanDefinitionBuilder.genericBeanDefinition(StaticQueryParamResolverFactoryBean.class);
  ...
  protected Object getMetadataProvider() {
    BeanDefinitionBuilder metadataProviderBuilder =
        BeanDefinitionBuilder.genericBeanDefinition(PreparedBulkUpdateMetadataProvider.class);
