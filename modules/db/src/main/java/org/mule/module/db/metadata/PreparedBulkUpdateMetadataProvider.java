...
public class PreparedBulkUpdateMetadataProvider extends UpdateMetadataProvider
{
    ...
    public PreparedBulkUpdateMetadataProvider(DbConfigResolver dbConfigResolver, QueryResolver queryResolver, AutoGeneratedKeyStrategy autoGeneratedKeyStrategy)
    {
