...
public abstract class AbstractAdvancedDbProcessorDefinitionParser extends AbstractDbProcessorDefinitionParser
{
    ...
    protected final static StatementStreamingResultSetCloser statementStreamingResultSetCloser = new StatementStreamingResultSetCloser();
    ...
    {
        builder.addPropertyValue(STATEMENT_STREAMING_RESULTSET_CLOSER_PROPERTY, statementStreamingResultSetCloser);
    }
}
