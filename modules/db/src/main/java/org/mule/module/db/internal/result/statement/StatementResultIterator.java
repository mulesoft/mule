...
public class StatementResultIterator implements Iterator<StatementResult>
{
    ...
    public boolean hasNext()
    {
        ...
        try
        {
            ...
            {
                if (processWhenNotFirstInvocation())
                    return cachedResult;
            }
            else
            {
    ...
    private boolean processWhenNotFirstInvocation() throws SQLException {
        ...
        if (generatedKeys == null && !moveToNextResult()) {
            int tempUpdateCount = statement.getUpdateCount();
            if (tempUpdateCount == NO_UPDATE_COUNT) {
