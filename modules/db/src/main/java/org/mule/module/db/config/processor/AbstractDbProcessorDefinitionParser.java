...
import org.mule.module.db.config.resolver.database.DefaultDbConfigResolverFactoryBean;
import org.mule.module.db.domain.statement.QueryStatementFactory;
import org.mule.module.db.resolver.database.StaticDbConfigResolver;
import org.mule.module.db.resolver.database.DynamicDbConfigResolver;
...
public abstract class AbstractDbProcessorDefinitionParser extends AbstractHierarchicalDefinitionParser
{
    ...
    protected void parseConfig(Element element, BeanDefinitionBuilder builder)
    {
        ...
        else if (config.startsWith("#["))
        {
            ...
            wrapper.addConstructorArgValue(config);
        }
        else
        {
