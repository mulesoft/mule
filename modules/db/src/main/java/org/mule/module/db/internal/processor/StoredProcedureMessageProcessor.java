...
public class StoredProcedureMessageProcessor extends AbstractSingleQueryDbMessageProcessor
{
    ...
    public StoredProcedureMessageProcessor(DbConfigResolver dbConfigResolver, QueryResolver queryResolver, QueryExecutorFactory queryExecutorFactory, TransactionalAction transactionalAction,
            boolean streaming)
    {
    ...
    private void closeIfPossible(QueryParamValue paramValue)
    {
        if (paramValue.getValue() instanceof Closeable)
        {
            ...
            {
                logger.warn("Could not close query param {} in the stored procedure", paramValue.getValue());
            }
        }
    }
