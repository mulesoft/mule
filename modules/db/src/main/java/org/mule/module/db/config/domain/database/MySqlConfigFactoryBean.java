...
public class MySqlConfigFactoryBean extends DbConfigFactoryBean
{
    ...
    private String addProperties(String url)
    {
        ...
        {
            properties.put("generateSimpleParameterMetadata", "true");
        }
        ...
        return effectiveUrl.append(buildQueryParams(properties)).toString();
    }

    private String buildQueryParams(Map<String, String> properties)
    {
