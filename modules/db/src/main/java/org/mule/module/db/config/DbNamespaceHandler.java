...
import static org.mule.module.db.config.domain.database.DbConfigDefinitionParser.HOST_ATTRIBUTE;
import static org.mule.module.db.config.domain.database.DbConfigDefinitionParser.LOGIN_TIMEOUT_ATTRIBUTE;
import static org.mule.module.db.config.domain.database.DbConfigDefinitionParser.PORT_ATTRIBUTE;
...
import org.mule.module.db.config.domain.database.DbConfigDefinitionParser;
import org.mule.module.db.config.domain.database.DbConfigFactoryBean;
import org.mule.module.db.config.domain.database.DerbyConfigFactoryBean;
import org.mule.module.db.config.domain.database.MySqlConfigFactoryBean;
import org.mule.module.db.config.domain.database.OracleConfigFactoryBean;
...
import org.mule.module.db.config.processor.UpdateProcessorBeanDefinitionParser;
