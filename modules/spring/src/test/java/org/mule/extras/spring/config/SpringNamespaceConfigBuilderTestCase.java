...
public class SpringNamespaceConfigBuilderTestCase extends AbstractScriptConfigBuilderTestCase
{

    public String getConfigResources()
    {
        return "test-xml-mule2-config.xml";
    }
...
//TODO RM* these have moved to the endpoint
