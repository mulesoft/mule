...
keytool -genkey -alias muleclient -keystore clientKeystore -storepass mulepassword -validity 9999 -dname "CN=localhost, O=Mule ESB, C=US"
...
keytool -genkey -alias muleserver -keystore serverKeystore -storepass mulepassword -validity 9999 -dname "CN=localhost, O=Mule ESB, C=US"
...
keytool -genkey -alias delme -keystore trustStore -storepass mulepassword -validity 9999 -dname "CN=delme, O=Mule ESB, C=US"
