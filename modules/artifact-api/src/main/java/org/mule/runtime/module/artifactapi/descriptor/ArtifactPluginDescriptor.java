 ...
 * LICENSE.txt file.
 */
package org.mule.runtime.module.artifactapi.descriptor;
...
public class ArtifactPluginDescriptor extends ArtifactDescriptor {
  ...
  private Optional<MuleLoaderDescriber> extensionModelDescriptorProperty = empty();
  ...
  /**
   * @return the {@link MuleLoaderDescriber} that will contain all mandatory values to generate an {@link ExtensionModel} from it.
   */
  public Optional<MuleLoaderDescriber> getExtensionModelDescriptorProperty() {
    return extensionModelDescriptorProperty;
  }

  /**
   * Takes a {@link MuleLoaderDescriber} that should contain the values used to properly initialize an {@link ExtensionModel}
   *
   * @param extensionModelLoaderDescriber the {@link MuleLoaderDescriber} with the values
   */
  public void setExtensionModelDescriptorProperty(MuleLoaderDescriber extensionModelLoaderDescriber) {
