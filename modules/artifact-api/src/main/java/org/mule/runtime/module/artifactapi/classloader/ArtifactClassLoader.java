...
public interface ArtifactClassLoader extends DisposableClassLoader, LocalResourceLocator, ClassLoaderLookupPolicyProvider {
  ...
  /**
   * Returns an enumeration of {@link URL <tt>URL</tt>} objects representing all the resources with the given name which are local
   * to the classloader
   *
   * @param name The resource name
   * @return An enumeration of {@link URL <tt>URL</tt>} objects for the resources
