...
class PluginLocalDependenciesBlacklist {
    ...
    private static List<BundleDescriptor> pluginsBlacklist = singletonList(new BundleDescriptor.Builder().setGroupId("test").setArtifactId("test").setVersion("test").build());
