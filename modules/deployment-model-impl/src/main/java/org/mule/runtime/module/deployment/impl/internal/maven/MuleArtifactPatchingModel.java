...
import static org.mule.runtime.module.deployment.impl.internal.maven.AbstractMavenClassLoaderConfigurationLoader.MULE_ARTIFACT_PATCHES_LOCATION;
import static org.mule.runtime.module.deployment.impl.internal.maven.AbstractMavenClassLoaderConfigurationLoader.MULE_ARTIFACT_PATCH_JSON_FILE_NAME;
  ...
  static synchronized MuleArtifactPatchingModel loadModel(String jarFile) throws IOException {
    if (!loadedModelByJAr.containsKey(jarFile)) {
      File pluginPatchJarFile =
          new File(new File(MuleContainerBootstrapUtils.getMuleHome(), MULE_ARTIFACT_PATCHES_LOCATION), jarFile);
