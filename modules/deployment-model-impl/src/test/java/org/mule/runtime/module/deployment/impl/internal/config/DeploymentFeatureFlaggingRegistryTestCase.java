...
@SmallTest
public class DeploymentFeatureFlaggingRegistryTestCase {

  private DeploymentFeatureFlaggingRegistry featureFlaggingRegistry;
  ...
  @Before
  public void setUp() {
    featureFlaggingRegistry = DeploymentFeatureFlaggingRegistry.getInstance();
  }
