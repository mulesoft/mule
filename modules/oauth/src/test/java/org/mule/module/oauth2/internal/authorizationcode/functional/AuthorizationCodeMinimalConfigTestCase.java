...
public class AuthorizationCodeMinimalConfigTestCase extends AbstractOAuthAuthorizationTestCase
{
    ...
    public void hitRedirectUrlAndGetToken() throws Exception
    {
        ...
        OAuthContextFunctionAsserter.createFrom(muleContext.getExpressionLanguage(), "minimalConfig")
