...
public class StateEncoderTestCase extends AbstractMuleTestCase
{
    ...
    {
        StateEncoder.encodeOAuthStateIdInState(ORIGINAL_STATE_VALUE, null);
    }

    @Test
    public void encodeAndDecodeWithState()
    {
        final String encodedState = StateEncoder.encodeOAuthStateIdInState(ORIGINAL_STATE_VALUE, TEST_OAUTH_ID);
        assertThat(StateEncoder.decodeOAuthStateId(encodedState), is(TEST_OAUTH_ID));
    ...
    {
        final String encodedState = StateEncoder.encodeOAuthStateIdInState(null, TEST_OAUTH_ID);
        assertThat(StateEncoder.decodeOAuthStateId(encodedState), is(TEST_OAUTH_ID));
