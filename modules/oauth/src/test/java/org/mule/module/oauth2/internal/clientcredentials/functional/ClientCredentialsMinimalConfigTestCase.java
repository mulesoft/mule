...
public class ClientCredentialsMinimalConfigTestCase extends AbstractOAuthAuthorizationTestCase
{
    ...
    public void authenticationIsDoneOnStartup() throws Exception
    {
        ...
        OAuthContextFunctionAsserter.createFrom(muleContext.getExpressionLanguage(), "clientCredentialsConfig")
    ...
    public void authenticationHeaderIsSentWithRequest() throws Exception
    {
        ...
        wireMockRule.verify(postRequestedFor(urlEqualTo(RESOURCE_PATH))
                                    .withHeader(HttpHeaders.Names.AUTHORIZATION, equalTo(OAuthAuthenticationHeader.buildAuthorizationHeaderContent(ACCESS_TOKEN))));
    }
