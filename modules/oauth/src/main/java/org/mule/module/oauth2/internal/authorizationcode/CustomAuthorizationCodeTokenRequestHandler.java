 ...
 * custom flows.
 */
public class CustomAuthorizationCodeTokenRequestHandler extends AbstractAuthorizationCodeTokenRequestHandler
{
    ...
    @Override
    protected void doRefreshToken(MuleEvent currentEvent, ResourceOwnerOAuthContext resourceOwnerOAuthContext) throws MuleException
    {
    ...
    public void init() throws MuleException
    {
        ...
        {
            logger.info("No listener was created in the redirect url since there's already once registered probably by a flow in the app config");
        }
    }
