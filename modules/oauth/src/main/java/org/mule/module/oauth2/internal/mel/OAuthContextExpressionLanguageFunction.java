...
public class OAuthContextExpressionLanguageFunction implements ExpressionLanguageFunction
{
    ...
    public Object call(final Object[] params, final ExpressionLanguageContext context)
    {
        ...
        OAuthGrantTypeConfig oauthGrantTypeConfig = registry.get(oauthConfigName);

        return oauthGrantTypeConfig.processOauthContextFunctionACall(Arrays.copyOfRange(params, 1, params.length));
    }
