 ...
 * LICENSE.txt file.
 */
package org.mule.extension.oauth2.internal.config;


import org.mule.extension.oauth2.internal.ParameterExtractor;
import org.mule.extension.oauth2.internal.authorizationcode.AuthorizationRequestHandler;
import org.mule.extension.oauth2.internal.authorizationcode.AutoAuthorizationCodeTokenRequestHandler;
...
import org.mule.extension.oauth2.internal.clientcredentials.ClientCredentialsTokenRequestHandler;
import org.mule.extension.oauth2.internal.tokenmanager.InvalidateOauthContextMessageProcessor;
  ...
  public void init() {
    ...
    final ParentContextDefinitionParser tokenRequestHandlerDefinitionParser =
        new ParentContextDefinitionParser("authorization-code-grant-type",
                                          new ChildDefinitionParser("tokenRequestHandler",
                                                                    AutoAuthorizationCodeTokenRequestHandler.class));
    ...
    registerMuleBeanDefinitionParser("custom-parameters",
                                     new GenericChildMapDefinitionParser("customParameters", "custom-parameter", "paramName",
                                                                         "value"));
