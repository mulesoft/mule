...
public class EndOnEndParentSpan implements InternalSpan {

  private final InternalSpan delegate;
  private final InternalSpan parentSpan;
  private Runnable endCallback;
  private BiConsumer<String, String> callBackOnAddAttribute;

  public EndOnEndParentSpan(InternalSpan delegate, InternalSpan parentSpan) {
    this.delegate = delegate;
    this.parentSpan = parentSpan;
    this.parentSpan.registerCallbackOnEnd(() -> delegate.end());
    this.parentSpan.registerCallbackOnAddAttribute((key, value) -> delegate.addAttribute(key, value));
  }
  ...
  public void registerCallbackOnAddAttribute(BiConsumer<String, String> callback) {
    this.callBackOnAddAttribute = callback;
  }
}
