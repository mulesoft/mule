...
public class HttpRequesterConfigBuilder {
  ...
  /**
   * To create instance of {@link TlsContextFactory} use {@link TlsContextFactoryBuilder}
   *
  ...
  /**
   * To create instances of {@link org.mule.runtime.module.http.api.requester.proxy.ProxyConfig} use
   * {@link org.mule.runtime.module.http.api.requester.proxy.NtlmProxyConfigBuilder} or
   ...
   *
   * @return an {@link org.mule.runtime.module.http.api.requester.HttpRequesterConfig} created with the provided configuration.
