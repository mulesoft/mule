...
import static org.mule.service.http.api.HttpConstants.ResponseProperties.HTTP_REASON_PROPERTY;
...
public class HttpResponseToMuleEvent {
  ...
  private void setResponsePayload(Object payload, Event muleEvent, Event.Builder eventBuilder) {
    if (StringUtils.isEmpty(requester.getTarget()) || DEFAULT_PAYLOAD_EXPRESSION.equals(requester.getTarget())) {
      ...
      muleContext.getExpressionManager().enrich(requester.getTarget(), muleEvent, eventBuilder, null, payload);
    }
  }
