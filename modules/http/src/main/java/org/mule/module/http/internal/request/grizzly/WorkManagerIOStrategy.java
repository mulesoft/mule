 ...
 */
public class WorkManagerIOStrategy extends AbstractIOStrategy
{

    private final static EnumSet<IOEvent> WORKER_THREAD_EVENT_SET =
            EnumSet.of(IOEvent.READ, IOEvent.CLOSED);

    private static final Logger logger = Grizzly.logger(WorkManagerIOStrategy.class);
    private final WorkManager workManager;

    public WorkManagerIOStrategy(final WorkManager workManager)
    {
