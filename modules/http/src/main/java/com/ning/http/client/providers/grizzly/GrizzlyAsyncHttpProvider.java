...
/**
 * A Grizzly 2.0-based implementation of {@link com.ning.http.client.AsyncHttpProvider}.
 *
 * @author The Grizzly Team
 * @since 1.7.0
 *
 * This is a modified version from the original file from AHC, with the DECOMPRESS_RESPONSE property usage in it.
 */
