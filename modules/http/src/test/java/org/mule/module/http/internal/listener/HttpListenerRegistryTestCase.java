...
public class HttpListenerRegistryTestCase extends AbstractMuleTestCase
{
    ...
    public void routeToCorrectHandler()
    {
        ...
        routePath(CATCH_ALL_IN_THE_MIDDLE_NO_COLLISION.replace(WILDCARD_CHARACTER, SOME_PATH) + ANOTHER_PATH, CATCH_ALL_IN_THE_MIDDLE_NO_COLLISION );
        routePath(SEVERAL_CATCH_ALL.replace(WILDCARD_CHARACTER, SOME_PATH), SEVERAL_CATCH_ALL);
        routePath(SEVERAL_CATCH_ALL.replace(WILDCARD_CHARACTER, SOME_PATH) + ANOTHER_PATH, SEVERAL_CATCH_ALL);
        routePath(SEVERAL_CATCH_ALL.replace(WILDCARD_CHARACTER, SOME_PATH) + ANOTHER_PATH, SEVERAL_CATCH_ALL);
