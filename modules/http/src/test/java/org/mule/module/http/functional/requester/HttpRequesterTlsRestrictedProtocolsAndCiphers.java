...
public class HttpRequesterTlsRestrictedProtocolsAndCiphers extends FunctionalTestCase
{
    ...
    {
        String path = ClassUtils.getClassPathRoot(HttpRequesterTlsRestrictedProtocolsAndCiphers.class).getPath();
