...
public class HttpRequest401TestCase extends AbstractHttpRequestTestCase
{
    ...
    public static final String UNAUTHORIZED_MESSAGE = "Unauthorized: check credetials.";
    ...
    public void returns401Response() throws Exception
    {
        ...
        assertThat((Integer) response.getInboundProperty(HTTP_STATUS_PROPERTY), is(401));
