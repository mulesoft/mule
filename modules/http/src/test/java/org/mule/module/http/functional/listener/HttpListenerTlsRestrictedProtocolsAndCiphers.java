...
public class HttpListenerTlsRestrictedProtocolsAndCiphers extends FunctionalTestCase
{
    ...
    {
        String path = ClassUtils.getClassPathRoot(HttpListenerTlsRestrictedProtocolsAndCiphers.class).getPath();
