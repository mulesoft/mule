...
public class HttpRequesterConfigBuilderTestCase extends AbstractMuleTestCase
{
    ...
    public void responseTimeout() throws Exception
    {
        ...
        assertThat(builder.setResponseTimeout(responseTimeout).build().getResponseTimeout(), is(String.valueOf(responseTimeout)));
    }
    ...
    {
        when(mockProxyConfig.getHost()).thenReturn("anyHost");
        when(mockProxyConfig.getPort()).thenReturn(9090);
