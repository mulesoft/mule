...
public class XPathFunctionTestCase extends FunctionalTestCase
{
    ...
    @Test
    public void dontChangePayload() throws Exception
    {
        MuleEvent event = this.runFlow("dontChangePayload", this.payload);
        assertEquals(this.payload, event.getMessage().getPayload());
    }
