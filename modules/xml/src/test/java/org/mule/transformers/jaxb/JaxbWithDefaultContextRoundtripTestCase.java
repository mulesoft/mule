...
public class JaxbWithDefaultContextRoundtripTestCase extends AbstractTransformerTestCase
{
    @Override
    public Transformer getTransformer() throws Exception
    {
        JAXBUnmarshallerTransformer t = new JAXBUnmarshallerTransformer();
        t.setReturnDataType(DataTypeFactory.create(Person.class));
        initialiseObject(t);
        return t;
    }
    ...
    {
        JAXBMarshallerTransformer t = new JAXBMarshallerTransformer();
        t.setSourceClass(Person.class);
        initialiseObject(t);
        return t;
