...
import static org.mule.module.xml.util.XMLTestUtils.getXmlMessageVariants;
...
public class DomXmlTransformersTestCase extends AbstractDomXmlTransformersTestCase
{
    ...
    {
        srcData = getResourceAsString("cdcatalog.xml", getClass());
        org.dom4j.Document dom4jDoc = parseText(srcData);
    ...
    public void testTransformXMLStreamReader() throws Exception
    {
        ...
        InputStream is = getResourceAsStream("cdcatalog.xml", XMLTestUtils.class);
    ...
    {
        List list = getXmlMessageVariants("cdcatalog.xml");
