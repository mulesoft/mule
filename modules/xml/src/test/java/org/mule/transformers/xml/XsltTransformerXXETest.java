...
public class XsltTransformerXXETest extends FunctionalTestCase
{
    ...
    public void xxeAsStream() throws Exception
    {
        ...
        this.runFlow("xxe", new ByteArrayInputStream(input.getBytes())).getMessage().getPayload();
    }
    ...
    {
        String input = this.makeInput();
        this.runFlow("xxe", input).getMessage().getPayload();
    }
    ...
    {
        String input = this.makeInput();
        this.runFlow("xxe", input.getBytes()).getMessage().getPayload();
    }
    ...
    {
        String input = this.makeInput();
        this.runFlow("unsafeXxe", new ByteArrayInputStream(input.getBytes())).getMessage().getPayload();
    }
    ...
    {
        String input = this.makeInput();
        this.runFlow("unsafeXxe", input).getMessage().getPayload();
    }
    ...
    {
        String input = this.makeInput();
        String output = (String) this.runFlow("unsafeXxe", input.getBytes()).getMessage().getPayload();
