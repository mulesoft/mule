...
public final class ElementDescriptor
{
     ...
     * @param parentNode {@code this} element's parent node
     */
    public ElementDescriptor(String name, Map<String, String> attributes, List<ElementDescriptor> childs, Node parentNode)
    {
        this.name = name;
