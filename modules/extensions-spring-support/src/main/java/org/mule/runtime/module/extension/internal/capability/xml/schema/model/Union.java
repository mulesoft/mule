...
public class Union extends Annotated {
   ...
   * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the simpleType
   * property.
   * <p/>
   * <p/>
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the
   * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the memberTypes
   * property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
