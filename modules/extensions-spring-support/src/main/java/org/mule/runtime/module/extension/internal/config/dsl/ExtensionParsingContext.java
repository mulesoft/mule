...
/**
 * Context to be used while registering parsers for an {@link ExtensionModel} definition,
 * to keep track of global data accross all the different definition parsers
 *
 * @since 4.0
 */
public class ExtensionParsingContext
{
    ...
    /**
     * Register an {@link ObjectType} to indicate it has already being parsed for the given
