...
public class Schema extends OpenAttrs {
  ...
  @XmlElements({@XmlElement(name = "redefine", type = Redefine.class), @XmlElement(name = "annotation", type = Annotation.class),
      @XmlElement(name = "import", type = Import.class), @XmlElement(name = "include", type = Include.class)})
  protected List<OpenAttrs> includeOrImportOrRedefine;
  @XmlElements({@XmlElement(name = "attribute", type = TopLevelAttribute.class),
      @XmlElement(name = "group", type = NamedGroup.class), @XmlElement(name = "notation", type = Notation.class),
      @XmlElement(name = "attributeGroup", type = NamedAttributeGroup.class),
      @XmlElement(name = "element", type = TopLevelElement.class), @XmlElement(name = "annotation", type = Annotation.class),
   ...
   * <p/>
   * <p/>
   * Objects of the following type(s) are allowed in the list {@link Redefine } {@link Annotation } {@link Import } {@link Include
   * }
   */
   ...
   * <p/>
   * <p/>
   * Objects of the following type(s) are allowed in the list {@link TopLevelAttribute } {@link NamedGroup } {@link Notation }
   * {@link NamedAttributeGroup } {@link TopLevelElement } {@link Annotation } {@link TopLevelComplexType }
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the
   * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the finalDefault
   * property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the
   * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the blockDefault
   * property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
