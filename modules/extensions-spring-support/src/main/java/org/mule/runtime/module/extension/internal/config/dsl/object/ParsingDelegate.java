 ...
 * then you can use the {@link #parse(String, MetadataType)} to obtain a
...
public interface ParsingDelegate<M extends MetadataType, T>
{
     ...
     * @return whether it's safe to call {@link #parse(String, MetadataType)} or not
     */
     ...
     * @return
     */
    T parse(String key, M metadataType);
}
