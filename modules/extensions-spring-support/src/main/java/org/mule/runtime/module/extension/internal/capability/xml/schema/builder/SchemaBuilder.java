...
public final class SchemaBuilder {
  ...
  public String EE_SCHEMA_LOCATION = format("%s/%s/%s.xsd", CLUSTER_EE_NAMESPACE, "current", EE_PREFIX);
  ...
  private Import createMuleEEImport() {
    Import muleSchemaImport = new Import();
    muleSchemaImport.setNamespace(CLUSTER_EE_NAMESPACE);
