...
public class MuleProvider extends AbstractProvider
{
    ...
    public ResponseContext request(RequestContext request)
    {
        ...
        try
        {
            ...
            MuleMessage res = ((Flow) ctx.getFlowConstruct()).process(
                    new DefaultMuleEvent(requestMessage, MessageExchangePattern.REQUEST_RESPONSE,
                                         ctx.getFlowConstruct())).getMessage();
