...
public final class StaxUtils {
    ...
    final boolean wstxMaxes = setProperty(factory, "com.ctc.wstx.maxAttributesPerElement", maxAttributeCount)
    ...
    public static void copy(XMLStreamReader reader,
        ...
        while (reader.hasNext()) {
            ...
            case XMLStreamConstants.CDATA:
                ...
                // Workaround woodstox issue that returns partial test for cdatas.
                // TODO https://github.com/FasterXML/woodstox/issues/21
                while (reader.hasNext() && event == XMLStreamConstants.CDATA) {
