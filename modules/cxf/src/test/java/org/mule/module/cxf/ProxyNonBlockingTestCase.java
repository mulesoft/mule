...
public class ProxyNonBlockingTestCase extends FunctionalTestCase
{
    ...
    public void testEchoProxy() throws Exception
    {
        ...
        SensingNullRequestResponseMessageProcessor.assertDifferentThreads(muleContext, "sensingRequestResponseProcessorEcho");
    }
    ...
    public void testGreeterProxy() throws Exception
    {
        ...
        SensingNullRequestResponseMessageProcessor.assertDifferentThreads(muleContext, "sensingRequestResponseProcessorGreeter");
    }
