...
public class CxfClientExceptionStrategyTestCase extends FunctionalTestCase
{
    ...
    public void testCxfClientExceptionStrategy() throws Exception
    {
        ...
        assertTrue(((ExceptionMessage) out.getPayload()).getException() instanceof MessagingException);
        assertTrue(((ExceptionMessage) out.getPayload()).getException().getMessage().contains("Error transforming message"));
        }
