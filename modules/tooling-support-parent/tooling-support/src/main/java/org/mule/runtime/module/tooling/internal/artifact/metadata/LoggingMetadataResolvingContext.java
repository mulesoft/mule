...
/**
 * An implementation of {@link MetadataContext} in order to provide logging for configuration and connections.
 */
public class LoggingMetadataResolvingContext extends LoggingResolvingContext implements MetadataContext {
   ...
   */
  public LoggingMetadataResolvingContext(Supplier<Optional<ConfigurationInstance>> configurationSupplier,
                                         ConnectionManager connectionManager, MetadataCache cache, ClassTypeLoader typeLoader) {
    super(new ExtensionResolvingContext(configurationSupplier, connectionManager));
    this.cache = cache;
