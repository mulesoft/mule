...
public enum FileError implements ErrorTypeDefinition<FileError> {
  ...
  FILE_NOT_FOUND, ILLEGAL_PATH, ILLEGAL_CONTENT, CONCURRENCY, FILE_ALREADY_EXISTS, ACCESS_DENIED, CONNECTIVITY(
      MuleErrors.CONNECTIVITY), FILE_DOESNT_EXIST(CONNECTIVITY), FILE_IS_NOT_DIRECTORY(CONNECTIVITY);
