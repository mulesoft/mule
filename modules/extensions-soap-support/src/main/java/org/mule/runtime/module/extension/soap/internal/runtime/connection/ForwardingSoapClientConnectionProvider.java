...
public class ForwardingSoapClientConnectionProvider implements PoolingConnectionProvider<ForwardingSoapClient> {
  ...
  public ForwardingSoapClient connect() throws ConnectionException {
    return new ForwardingSoapClient(soapService, serviceProvider, getMessageDispatcher());
  }
  ...
  private MessageDispatcher getMessageDispatcher() {
    return serviceProvider.getCustomDispatcher().orElse(new DefaultHttpMessageDispatcher(httpService));
  }
}
