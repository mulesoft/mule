...
/**
 * Resolves the input metadata for the request body for the soap connect invoke operation
 *
 * @since 4.0
 */
public final class InvokeRequestTypeResolver extends BaseInvokeResolver implements InputTypeResolver<WebServiceTypeKey> {
