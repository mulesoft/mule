...
public abstract class AbstractExternalTransactionTestCase extends FunctionalTestCase
{
    ...
    protected TransactionManagerProperties tmProperties;
    ...
    protected void init(boolean joinExternal) throws Exception
    {
        context = createMuleContext();
        tmProperties = context.getTransactionManagerProperties();
        assertEquals(joinExternal, tmProperties.isJoinExternal());
        tm = context.getTransactionManager();
    }

    protected TransactionTemplate createTransactionTemplate(byte action)
    {
