 ...
 */
public interface LongCounterBuilderWithInstrumentRepository extends LongCounterBuilder {

  /**
   * @param instrumentRepository the instrument repository.
   * @return the corresponding {@link LongCounterBuilderWithInstrumentRepository}.
   */
  LongCounterBuilderWithInstrumentRepository withInstrumentRepository(InstrumentRepository instrumentRepository);
}
