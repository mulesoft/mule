...
public class FileMeterExporterConfigurationTestCase {
  ...
  public void whenValueCorrespondingToPathGetAbsoluteValue() {
    ...
    final Path caFileLocationPath = Paths.get(caFileLocation);
    final Path keyFileLocationPath = Paths.get(keyFileLocation);
