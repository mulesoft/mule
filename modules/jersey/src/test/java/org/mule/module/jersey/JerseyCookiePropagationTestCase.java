...
public class JerseyCookiePropagationTestCase extends FunctionalTestCase
{
    ...
    public static Collection<Object[]> parameters()
    {
        return Arrays.asList(new Object[][] {
                new Object[] {"jersey-cookie-config-flow.xml"},
                new Object[] {"jersey-cookie-http-connector-config-flow.xml"}
        });
    }

    private String configFile;

    public JerseyCookiePropagationTestCase(String configFile)
    {
