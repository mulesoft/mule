...
public final class AstXmlParserArtifactConfigurationProcessor extends AbstractAstConfigurationProcessor {
  ...
  private org.mule.runtime.ast.api.ArtifactType toAstArtifactType(ArtifactType artifactType) {
    return switch (artifactType) {
      case APP -> org.mule.runtime.ast.api.ArtifactType.APPLICATION;
      case DOMAIN -> org.mule.runtime.ast.api.ArtifactType.DOMAIN;
      case POLICY -> org.mule.runtime.ast.api.ArtifactType.POLICY;
      default -> throw new IllegalArgumentException("The provided artifact type '" + artifactType + "' cannot be deployed.");
    };
  }
