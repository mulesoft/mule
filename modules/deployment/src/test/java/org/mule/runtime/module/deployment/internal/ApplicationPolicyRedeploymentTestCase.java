...
public class ApplicationPolicyRedeploymentTestCase extends AbstractDeploymentTestCase {
  ...
  private Reference<OperationPolicy> getPrintMessageOperationPolicyRef(String applicationId) {
    Application app = findApp(applicationId, 1);
    ...
    ConfigurationComponentLocator locator = registry.lookupByType(ConfigurationComponentLocator.class).get();
    Component operation = locator.find(componentIdentifier).get(0);
