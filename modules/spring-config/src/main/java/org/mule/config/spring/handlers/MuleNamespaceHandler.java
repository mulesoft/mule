...
import org.mule.config.spring.factories.CustomMergeStrategyDefinitionParser;
...
import org.mule.config.spring.parsers.specific.GlobalFunctionsDefintionParser;
...
public class MuleNamespaceHandler extends AbstractMuleNamespaceHandler
{
    ...
    public void init()
    {
        ...
        registerBeanDefinitionParser("custom-merge-strategy", new CustomMergeStrategyDefinitionParser());
