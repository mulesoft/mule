 ...
 *
 * It will return a {@link org.mule.runtime.core.api.retry.RetryPolicyTemplate} that may run synchronously or asynchronously
 * based on the {@code blocking} configuration.
 *
 * @since 4.0
 */
