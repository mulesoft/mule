...
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.HTTP_PROXY_SOURCE_POLICY_IDENTIFIER;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.MODULE_OPERATION_CHAIN;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.MUNIT_AFTER_SUITE_IDENTIFIER;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.MUNIT_AFTER_TEST_IDENTIFIER;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.MUNIT_BEFORE_SUITE_IDENTIFIER;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.MUNIT_BEFORE_TEST_IDENTIFIER;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.MUNIT_TEST_IDENTIFIER;
import static org.mule.runtime.config.spring.api.dsl.model.ApplicationModel.SUBFLOW_IDENTIFIER;
import static org.mule.runtime.config.spring.internal.dsl.model.extension.xml.MacroExpansionModuleModel.ORIGINAL_IDENTIFIER;
import static org.mule.runtime.config.spring.internal.dsl.spring.ComponentModelHelper.isErrorHandler;
import static org.mule.runtime.config.spring.internal.dsl.spring.ComponentModelHelper.isMessageSource;
import static org.mule.runtime.config.spring.internal.dsl.spring.ComponentModelHelper.isProcessor;
