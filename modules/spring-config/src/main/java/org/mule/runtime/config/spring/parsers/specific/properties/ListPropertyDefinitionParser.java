...
/**
 * This allows a child element to extends a list of values, via an attribute, on a parent setter. Typically it is used with
 * {@link org.mule.runtime.config.spring.parsers.specific.properties.ElementInNestedMapDefinitionParser} whose setter is
...
public class ListPropertyDefinitionParser extends ParentDefinitionParser {
  ...
  /**
   * This method is to explain how things work. If you need to call it, then you also need to replace override the class ({#link
   * #getBeanClass}).
   *
   * @param setter
   * @param attribute
