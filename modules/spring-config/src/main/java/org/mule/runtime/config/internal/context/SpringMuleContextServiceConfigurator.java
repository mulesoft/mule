...
import org.mule.runtime.tracing.level.impl.config.OpenTelemetryAutoConfigurableTracingLevelConfiguration;
...
public class SpringMuleContextServiceConfigurator extends AbstractSpringMuleContextServiceConfigurator {
  ...
  private final ImmutableMap<String, BeanDefinition> defaultContextServices = ImmutableMap.<String, BeanDefinition>builder()
      ...
      .put(MULE_TRACING_LEVEL_CONFIGURATION_KEY, getBeanDefinition(OpenTelemetryAutoConfigurableTracingLevelConfiguration.class))
