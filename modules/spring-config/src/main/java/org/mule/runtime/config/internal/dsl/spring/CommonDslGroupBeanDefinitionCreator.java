 ...
 * @since 4.0
 */
class CommonDslGroupBeanDefinitionCreator extends BaseCommonBeanDefinitionCreator<CreateDslParamGroupBeanDefinitionRequest> {

  public CommonDslGroupBeanDefinitionCreator(ObjectFactoryClassRepository objectFactoryClassRepository) {
