...
import static org.mule.runtime.extension.api.loader.util.InfrastructureTypeUtils.getInfrastructureTypes;
            ...
            .forEach((name, value) -> value.accept(new ParameterValueVisitor() {
              ...
              public void visitObjectValue(ParameterObjectValue objectValue) {
                ...
                if (TLS_REVOCATION_CHECK_ELEMENT_IDENTIFIER.equals(name)) {
                  getInfrastructureTypes(objectValue.getTypeId()).iterator().next()
