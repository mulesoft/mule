...
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.CONFIGURATION_PROPERTIES;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.DESCRIPTION_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.DOC_DESCRIPTION_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.ERROR_MAPPING_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.GLOBAL_PROPERTY_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.MULE_DOMAIN_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.MULE_EE_DOMAIN_IDENTIFIER;
...
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.OBJECT_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.RAISE_ERROR_IDENTIFIER;
import static org.mule.runtime.config.api.dsl.model.ApplicationModel.SECURITY_MANAGER_IDENTIFIER;
