 ...
 * @since 4.0
 */
abstract class BaseCommonBeanDefinitionCreator<R extends CreateBeanDefinitionRequest> extends BeanDefinitionCreator<R> {

  private final ObjectFactoryClassRepository objectFactoryClassRepository;

  public BaseCommonBeanDefinitionCreator(ObjectFactoryClassRepository objectFactoryClassRepository) {
  ...
  public boolean handleRequest(Map<ComponentAst, SpringComponentModel> springComponentModels,
    ...
    BeanDefinitionBuilder beanDefinitionBuilder =
        createBeanDefinitionBuilder(type, request.getSpringComponentModel(), buildingDefinition);
  ...
  private BeanDefinitionBuilder createBeanDefinitionBuilder(Class<Object> type,
    ...
    if (buildingDefinition.getObjectFactoryType() != null) {
      beanDefinitionBuilder = createBeanDefinitionBuilderFromObjectFactory(type, componentModel, buildingDefinition);
    } else {
  ...
  private BeanDefinitionBuilder createBeanDefinitionBuilderFromObjectFactory(final Class<Object> type,
    ...
    return rootBeanDefinition(objectFactoryClassRepository
        .getObjectFactoryClass(componentBuildingDefinition, objectFactoryType, type,
