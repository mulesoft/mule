...
/**
 * Specialization of {@link DefaultLifecycleObjectSorter} which uses an {@link SpringRegistry} to not only consider the provided
 * objects but the beans on which that object depends on. This is accomplished by introspecting the {@link BeanDefinition} that
 * was derived from the {@link Inject} annotations. This sorter was introduced to replace SpringLifecycleObjectSorter.
 *
 * @since 4.5.0
 */
