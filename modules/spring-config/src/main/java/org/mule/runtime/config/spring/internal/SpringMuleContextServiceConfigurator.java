...
import static org.mule.runtime.config.spring.api.LazyComponentInitializer.LAZY_COMPONENT_INITIALIZER_SERVICE_KEY;
...
import org.mule.runtime.config.spring.internal.dsl.model.config.DefaultComponentInitialStateManager;
import org.mule.runtime.config.spring.internal.factories.ConstantFactoryBean;
import org.mule.runtime.config.spring.internal.factories.ExtensionManagerFactoryBean;
import org.mule.runtime.config.spring.internal.factories.TransactionManagerFactoryBean;
import org.mule.runtime.config.spring.internal.processor.MuleObjectNameProcessor;
...
class SpringMuleContextServiceConfigurator {
  ...
  private final ImmutableMap<String, BeanDefinition> defaultContextServices = ImmutableMap.<String, BeanDefinition>builder()
      ...
      .put(ProcessorInterceptorManager.REGISTRY_KEY, getBeanDefinition(DefaultProcessorInterceptorManager.class))
