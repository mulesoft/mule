...
public class JsonSchemaValidatorTestCase extends AbstractMuleContextTestCase
{
    ...
    public static Iterable<Object[]> data() throws Exception
    {
        return Arrays.asList(new Object[][] {
                ...
                {"SimpleV4Schema as bytes", getFstabValidator(), getGoodFstab(), getBadFstab(), getBadFstab2()},
                ...
                {"Inline schema as Stream", getInlineFstabValidator(), getGoodFstabInlineAsJsonData(), getBadFstabAsJsonData(), getBadFstab2AsJsonData()},
                ...
                {"Draft3 as JsonData", getDraft3Validator(), fromString(getGoodFstab()), fromString(getBadFstab()), fromString(getBadFstab2())},
                ...
                {"Schema with redirects as JsonData", getFstabValidatorWithRedirects(), fromString(getGoodFstab()), fromString(getBadFstab()), fromString(getBadFstab2())},
