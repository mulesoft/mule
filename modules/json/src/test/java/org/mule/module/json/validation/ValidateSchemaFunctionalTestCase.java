...
public class ValidateSchemaFunctionalTestCase extends AbstractValidateSchemaFunctionalTestCase
{
    ...
    public static Iterable<Object[]> data() throws Exception
    {
        return Arrays.asList(new Object[][] {
                ...
                {"SimpleV4Schema as bytes", SCHEMA_FSTAB_JSON, CANONICAL, getGoodFstab(), getBadFstab(), getBadFstab2()},
                ...
                {"Inline schema as Stream", SCHEMA_FSTAB_INLINE, INLINE, getGoodFstabInlineAsJsonData(), getBadFstabAsJsonData(), getBadFstab2AsJsonData()},
                ...
                {"Draft3 as JsonData", SCHEMA_FSTAB_DRAFTV3, CANONICAL, fromString(getGoodFstab()), fromString(getBadFstab()), fromString(getBadFstab2())},
