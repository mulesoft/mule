...
public final class ClassLoaderModel extends ClassLoaderConfiguration {
  ...
  private ClassLoaderModel(URL[] urls, Set<String> exportedPackages, Set<String> exportedResources,
    ...
    super(urls, exportedPackages, exportedResources, localPackages, localResources, dependencies, privilegedExportedPackages,
  ...
  public static ClassLoaderModel fromClassLoaderConfiguration(ClassLoaderConfiguration classLoaderConfiguration) {
    return new ClassLoaderModel(classLoaderConfiguration.getUrls(), classLoaderConfiguration.getExportedPackages(),
                                classLoaderConfiguration.getExportedResources(), classLoaderConfiguration.getLocalPackages(),
                                classLoaderConfiguration.getLocalResources(), classLoaderConfiguration.getDependencies(),
                                classLoaderConfiguration.getPrivilegedExportedPackages(),
                                classLoaderConfiguration.getPrivilegedArtifacts(),
                                classLoaderConfiguration.isIncludeTestDependencies());
  }
