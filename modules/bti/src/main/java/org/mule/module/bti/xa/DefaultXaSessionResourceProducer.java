 ...
 * LICENSE.txt file.
 */
package org.mule.module.bti.xa;
...
public class DefaultXaSessionResourceProducer extends ResourceBean implements XAResourceProducer
{
    ...
    /**
     * @param uniqueName This parameter must be unique across the whole mule instance since the transaction manager is static for the whole container.
     * @param xaResourceManager
     */
