...
public class JavaExtensionModelParserTestCase {
  ...
  public void getMMVForLegacyExtension() {
    ...
    assertThat(parser.getMinMuleVersion().isPresent(), is(true));
    assertThat(parser.getMinMuleVersion().get(), is(FIRST_MULE_VERSION));
  ...
  public void getMMVForSdkExtension() {
    ...
    assertThat(parser.getMinMuleVersion().isPresent(), is(true));
    assertThat(parser.getMinMuleVersion().get().toString(), is("4.5.0"));
    assertThat(parser.getMinMuleVersionReason().get(),
  ...
  public void getMMVForExtensionWithSuperExtension() {
    ...
    assertThat(parser.getMinMuleVersion().isPresent(), is(true));
    assertThat(parser.getMinMuleVersion().get().toString(), is("4.4"));
    assertThat(parser.getMinMuleVersionReason().get(),
  ...
  public void getMMVForExtensionAnnotatedWithHighMMV() {
    ...
    assertThat(parser.getMinMuleVersion().isPresent(), is(true));
    assertThat(parser.getMinMuleVersion().get().toString(), is("4.7"));
    assertThat(parser.getMinMuleVersionReason().get(),
