...
public class FlatExtensionDeclarationTestCase extends BaseExtensionDeclarationTestCase
{
    ...
    {
        factory.createFrom(new ExtensionDeclarer().named("bad").onVersion("i'm new"), new DefaultDescribingContext(extensionDeclarer, getClass().getClassLoader()));
    }
    ...
    public void configurationsOrder()
    {
        ...
        ExtensionModel extensionModel = factory.createFrom(declarer, new DefaultDescribingContext(extensionDeclarer, getClass().getClassLoader()));
    ...
    public void nameClashes()
    {
        ...
        factory.createFrom(extensionDeclarer, new DefaultDescribingContext(extensionDeclarer, getClass().getClassLoader()));
    }
    ...
    {
        factory.createFrom(new ExtensionDeclarer().named("noConfigs").onVersion("1.0").fromVendor("MuleSoft"), new DefaultDescribingContext(extensionDeclarer, getClass().getClassLoader()));
    }
