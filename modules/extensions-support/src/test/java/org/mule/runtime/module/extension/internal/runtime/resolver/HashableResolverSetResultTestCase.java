...
@SmallTest
public class HashableResolverSetResultTestCase extends AbstractMuleTestCase {
  ...
  private ResolverSetResult.Builder getBuilder() {
    return HashableResolverSetResult.newBuilder().add(nameParameterModel.getName(), NAME).add(ageParameterModel.getName(), AGE)
