...
public class ExecutionTypeModelEnricherTestCase extends AbstractMuleTestCase {
  ...
  private ExecutionTypeModelEnricher enricher = new ExecutionTypeModelEnricher();
