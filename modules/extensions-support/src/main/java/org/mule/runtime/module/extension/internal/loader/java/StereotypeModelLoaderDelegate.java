...
public class StereotypeModelLoaderDelegate {
  ...
  public StereotypeModelLoaderDelegate(ExtensionLoadingContext extensionLoadingContext, String version) {
  ...
  public void addStereotype(StereotypeModelParser parser,
    ...
    processStereotypes(parser, declarer, fallback);
  ...
  private <T extends HasStereotypeDeclarer & HasModelProperties> StereotypeModel processStereotypes(
