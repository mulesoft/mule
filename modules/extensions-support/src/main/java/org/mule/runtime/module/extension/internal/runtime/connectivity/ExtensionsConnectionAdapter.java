...
/**
 * A bridge between the execution of an operation and the {@link ConnectionManager}
 * which provides the connections that it needs.
 * <p>
...
public class ExtensionsConnectionAdapter
{
     ...
     * <p>
     * It accounts for the possibility of the returned connection joining/belonging
     ...
     */
    public ConnectionHandler<?> getConnection(OperationContextAdapter operationContext) throws ConnectionException, TransactionException
    {
