  ...
  public FunctionExecutor createExecutor(FunctionModel functionModel,
    ...
    List<FunctionParameter> functionParameters = functionModel.getAllParameterModels().stream().map(p -> {
      ...
      if (defaultValue == null) {
        return new FunctionParameter(p.getName(), type, context -> null);
      }
    ...
    return new ReflectiveExpressionFunctionExecutor(functionModel, returnType, functionParameters, method, delegate);
  }
