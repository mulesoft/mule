...
public final class ExtensionsOAuthUtils {
   ...
   * @since 4.3.0
   */
  public static <T extends OAuthState> FieldSetter<Object, T> getOAuthStateSetter(Object target,
                                                                                  Class<T> stateType,
  ...
  /**
   * Updates the {@code target} state with the values from the given {@code context}. This includes not only the
   * provider's inner {@link OAuthState} but also the fields annotated with {@link OAuthCallbackValue}
   *
