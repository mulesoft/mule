 ...
 * is participating on a transaction.
 *
...
final class TransactionalConnectionHandler<T extends TransactionalConnection> implements ConnectionHandlerAdapter<T>
{
    ...
    /**
     * Does nothing since the connection shouldn't be released until
     ...
     * If the transaction is still active, then it rolls it back
     *
