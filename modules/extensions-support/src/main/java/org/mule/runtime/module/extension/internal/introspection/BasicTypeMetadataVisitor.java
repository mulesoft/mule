...
/**
 * Base implementation for a {@link MetadataTypeVisitor} which adds the new
 * method {@link #visitBasicType(MetadataType)} which is invoked by all the types
 * which refer to a basic type. Those would be:
 * <p/>
 * <ul>
