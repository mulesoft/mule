...
/**
 * Decorates a {@link OperationExecutorFactory} so that the instances that it
 * generates are also decorated through a {@link InterceptableOperationExecutorWrapper},
 * so that the items in the {@link #interceptors} list can apply.
 *
 * @since 4.0
 */
public final class OperationExecutorFactoryWrapper implements OperationExecutorFactory
{
    ...
    {
        OperationExecutor executor = delegate.createExecutor();
