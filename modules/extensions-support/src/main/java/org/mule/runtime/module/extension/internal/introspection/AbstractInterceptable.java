 ...
 * <p>
 * Besides holding and managing a {@link List} of {@link Interceptor interceptors},
 * this class also implements {@link Lifecycle} making sure that all the lifecycle
 * phases are propagated to all the contained {@link #interceptors}.
 * <p>
 * It also provides behaviour for performing dependency injection into those {@link #interceptors},
 * including holding a {@link #muleContext} instance which is declared as an injection target.
 *
 * @since 4.0
 */
public abstract class AbstractInterceptable implements Interceptable, Lifecycle
{
    ...
    /**
     * Propagates this phase to all the {@link #interceptors}. All the {@link Interceptor interceptors}
     * held will receive the phase regardless of any (or all) of them throwing exceptions, in which case,
