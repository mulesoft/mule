 ...
 * {@link WrapperType wrapper types}.
 *
 * @since 4.0
 */
public class WrapperTypeParameterContributor implements ParameterDeclarerContributor {
  ...
  private Map<Class, WrapperType> wrapperTypes;

  private WrapperTypeParameterContributor(ClassTypeLoader typeLoader, Map<Class, WrapperType> wrapperTypes) {
   ...
   * as {@link WrapperType wrapper types}
   *
  ...
  public void contribute(ExtensionParameter parameter, ParameterDeclarer declarer,
    ...
    LazyValue<WrapperTypesModelProperty.Builder> stackedTypesModelPropertyBuilder =
        new LazyValue<>(WrapperTypesModelProperty::builder);
  ...
  private void doContribute(ExtensionParameter extensionParameter, ParameterDeclarationContext declarationContext,
                            ResolvableType resolvableType, LazyValue<WrapperTypesModelProperty.Builder> builder) {
  ...
  public static class Builder {
    ...
    private Map<Class, WrapperType> wrapperTypes = new HashMap<>();
    ...
    public Builder addWrapperType(WrapperType wrapperType) {
      wrapperTypes.put(wrapperType.getType(), wrapperType);
      return this;
    }
