...
public interface ValueSetter
{
    ...
    /**
     * Sets on {@code target} values contained in {@code result}. This method
     * does not guarantee how many of the values contained in {@code result} are
     * actually assigned (if any). Implementations are free to decide using
     * only a sub set of those values or none at all
     *
