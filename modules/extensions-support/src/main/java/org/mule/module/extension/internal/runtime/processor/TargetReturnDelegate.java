...
/**
 * An implementation of {@link AbstractReturnDelegate} which sets the output
 * message on a variable which key is taken from the {@link #target} field.
 * <p>
 * The target variable will always contain a {@link MuleMessage}, even if
 * the operation returned a simple value
 * <p>
