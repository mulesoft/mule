...
/**
 * Enriches the {@link DeclarationDescriptor} with a model property which key is {@value StudioModelProperty#KEY} and the value an instance of {@link StudioModelProperty}.
 * <p/>
 *
 * @since 4.0
 */
public final class StudioModelEnricher extends AbstractAnnotatedModelEnricher
{
    ...
    {
        String editorFileName = CustomStudioEditor.DEFAULT_FILENAME;
        ...
        if(studioProvidedEditor!=null){
            generated = studioProvidedEditor.generated();
        }
        return new ImmutableStudioModelProperty(editorFileName, generated);
    }
}
