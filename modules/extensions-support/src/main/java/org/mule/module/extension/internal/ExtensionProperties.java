...
public class ExtensionProperties
{
    ...
    /**
     * The key of an operation's variable on which the corresponding {@link ContentType} is available
     */
     ...
     */
    public static final String MIME_TYPE_PARAMETER_NAME = "mimeType";
