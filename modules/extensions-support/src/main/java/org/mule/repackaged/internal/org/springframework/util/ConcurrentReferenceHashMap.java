...
package org.mule.repackaged.internal.org.springframework.util;
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>
{
                                      ...
                                      ReferenceType referenceType)
    {
        ...
        Preconditions.checkArgument(referenceType != null, "Reference type must not be null");
    ...
    private class EntryIterator implements Iterator<Map.Entry<K, V>>
    {
        ...
        public void remove()
        {
            Preconditions.checkState(this.last != null, "Can't remove from empty entry");
