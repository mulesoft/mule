...
import com.ss.jaas.provider.JaasSecurityContextFactory;
...
public class JaasSimpleAuthenticationProvider implements UMOSecurityProvider {
	...
	private String DefaultModule = "com.ss.jaas.loginmodule.DefaultLoginModule";
	...
	public UMOAuthentication authenticate(UMOAuthentication authentication)
	    ...
	    logger.info("********************************************* authenticate was called ******************************************");
	...
	public static class JaasConfig extends Configuration {
		...
		public AppConfigurationEntry[] getAppConfigurationEntry(String applicationName) {				
			logger.info("********************************************* getAppConfigurationEntry was called ******************************************");
