...
import org.mule.runtime.module.artifact.activation.internal.service.ServiceFileBuilder;
...
import org.mule.runtime.module.artifact.activation.internal.service.manager.ServiceRegistryTestCase.FooService;
...
public class FileSystemServiceProviderDiscovererTestCase extends AbstractMuleTestCase {
  ...
  public void discoversNoServices() throws Exception {
    ...
    MatcherAssert.assertThat(discover, is(empty()));
  }
