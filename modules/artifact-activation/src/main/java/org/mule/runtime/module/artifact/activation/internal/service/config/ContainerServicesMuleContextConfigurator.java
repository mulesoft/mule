 ...
 * dependencies.
 */
public class ContainerServicesMuleContextConfigurator implements ServiceConfigurator {
   ...
   */
  public ContainerServicesMuleContextConfigurator(List<Service> services) {
