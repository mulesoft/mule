...
/**
 * CXF Interceptor that makes use of a Namespace Restorer XMLStream to allow the first element of the body to carry all the
 * namespaces from the parent nodes. This interceptor works with {@link NamespaceSaverStaxInterceptor}
 */
