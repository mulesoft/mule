...
public class WssNoCheckTimestampInResponseTestCase extends FunctionalTestCase
{
    @Rule
    public DynamicPort dynamicPortServerNoTSInResponse = new DynamicPort("portServerNoTSInResponse");

    @Rule
    public SystemProperty useConnectorToRetrieveWsdl = new SystemProperty(MULE_CHECK_TIMESTAMP_IN_WSS_RESPONSE, "false");
    ...
    {
        return "wss-timestamp-in-response-test-case-no-check.xml";
    }
