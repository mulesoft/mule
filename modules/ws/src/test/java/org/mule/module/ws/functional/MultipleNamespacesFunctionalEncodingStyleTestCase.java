 ...
 */
public class MultipleNamespacesFunctionalEncodingStyleTestCase extends AbstractWSConsumerFunctionalTestCase
{
    ...
    {
        return "multiple-namespaces-encodingStyle-config.xml";
    }
