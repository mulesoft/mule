 ...
 * LICENSE.txt file.
 */
package org.mule.annotations.config;

import org.mule.annotations.api.EndpointAnnotationParser;
import org.mule.annotations.api.MessageProcessorAnnotationParser;
...
public interface AnnotationsParserFactory
{
     ...
     * the {@link org.mule.annotations.api.annotations.meta.Evaluator} annotation.
     * <p/>
     *
     * @param annotation the annotation being processed
     ...
     * the {@link org.mule.annotations.api.annotations.meta.Router} annotation. the parameters passed in can be used to validate the use of
     * the annotation, i.e. you may want to restrict annotations to only be configured on concrete classes.
     * <p/>
     *
     * @param annotation the annotation being processed
