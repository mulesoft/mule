 ...
 * This annotation value can define a single header, a comma-separated list of header names, or '*' to denote all headers. By default,
 * if a named header is not present on the current message, an exception will be thrown. However, if the header name is defined with the '?' postfix, it
 ...
 * {@link java.util.Map} is used, the header name and value is passed in. If {@link java.util.List} is used, just the header values are used. If a single header name is
 * defined, the header type can be used as the parameter type, though {@link java.util.List} or {@link java.util.Map} can be used too.
 *
