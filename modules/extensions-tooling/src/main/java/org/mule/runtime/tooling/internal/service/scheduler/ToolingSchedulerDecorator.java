...
public class ToolingSchedulerDecorator implements Scheduler {

  private static final Logger LOGGER = getLogger(ToolingSchedulerDecorator.class);

  private final String name;
  private final Scheduler decorated;
  private final ToolingSchedulerService ownerService;
  private boolean stopped;

  private Collection<ScheduledFuture> recurrentTasks = new LinkedList<>();

  public ToolingSchedulerDecorator(String name, Scheduler decorated,
                                   ToolingSchedulerService ownerService) {
    super();
    this.name = name;
  ...
  public String getName() {
    return ToolingSchedulerDecorator.class.getSimpleName() + ":" + decorated.getName() + "(" + name + ")";
  }
