 ...
 * @since 4.0
 */
public class ToolingScheduler extends ScheduledThreadPoolExecutor implements Scheduler {

  private AtomicInteger scheduledTasks = new AtomicInteger(0);

  public ToolingScheduler(int corePoolSize,
  ...
  public String getName() {
    return ToolingScheduler.class.getSimpleName();
  }
}
