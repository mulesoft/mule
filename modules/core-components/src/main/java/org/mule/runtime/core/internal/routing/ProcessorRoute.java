...
import org.mule.runtime.core.api.tracing.customization.FixedNameCoreEventStartSpanInfoProvider;
...
public class ProcessorRoute extends AbstractComponent implements MuleContextAware, Lifecycle {
  ...
  private CoreEventStartSpanInfoProvider spanCustomizationInfo = new FixedNameCoreEventStartSpanInfoProvider("route");
