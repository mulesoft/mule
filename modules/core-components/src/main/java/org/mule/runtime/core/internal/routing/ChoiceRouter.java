...
import org.mule.runtime.core.api.tracing.customization.SuffixComponentEventBasedStartSpanInfoProvider;
...
public class ChoiceRouter extends AbstractComponent implements Router, RouterStatisticsRecorder, Lifecycle, MuleContextAware {
  ...
  public void initialise() throws InitialisationException {
    ...
    for (ProcessorRoute route : routes) {
      route.setCoreSpanCustominzationInfoProvider(new SuffixComponentEventBasedStartSpanInfoProvider(this, "route"));
