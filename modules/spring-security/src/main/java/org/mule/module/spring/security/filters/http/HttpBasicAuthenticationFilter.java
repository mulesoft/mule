/*
 * $Id: HttpBasicAuthenticationFilter.java 10662 2008-02-01 13:10:14Z romikk $
 * --------------------------------------------------------------------------------------
...
public class HttpBasicAuthenticationFilter extends AbstractEndpointSecurityFilter
{
    ...
    protected void doInitialise() throws InitialisationException
    {
        if (realm == null)
        {
            if (isRealmRequired())
            {
                throw new InitialisationException(SpringSecurityMessages.authRealmMustBeSetOnFilter(), this);
            }
            else
            {
