 ...
 * <p/>
 * Each {@link DescriptorProperty} will have an ID that will be used to discover any loader that's responsible of working
...
public class DescriptorProperty {
  ...
  /**
   * Creates an immutable implementation of {@link DescriptorProperty}
   *
   * @param id ID of the descriptor. Not blank nor null.
   */
  public DescriptorProperty(String id) {
