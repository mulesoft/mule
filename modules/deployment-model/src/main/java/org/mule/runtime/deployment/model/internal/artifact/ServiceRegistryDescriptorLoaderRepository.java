...
import org.mule.runtime.module.artifact.internal.descriptor.DescriptorLoaderUtils;
...
public class ServiceRegistryDescriptorLoaderRepository implements DescriptorLoaderRepository {
  ...
  public ServiceRegistryDescriptorLoaderRepository() {
    this(DescriptorLoaderUtils::lookupComponentBuildingDefinitionProviders);
  }
  ...
  private List<DescriptorLoader> findBundleDescriptorLoaders(Class<? extends DescriptorLoader> descriptorLoaderClass) {
    ...
    Collection<? extends DescriptorLoader> providers = serviceRegistry.apply(descriptorLoaderClass)
        .collect(toList());
