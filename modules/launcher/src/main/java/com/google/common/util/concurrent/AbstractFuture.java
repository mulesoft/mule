...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess
     ...
     */
    @Override
    protected final @NullableDecl Throwable tryInternalFastPathGetFailure() {
     ...
     * @since 23.0
     */
    protected @NullableDecl String pendingToString() {
    ...
    private static void executeListener(Runnable runnable, Executor executor) {
        try {
            ...
            // Keep going -- bad runnable and/or executor. Don't punish the other runnables if
