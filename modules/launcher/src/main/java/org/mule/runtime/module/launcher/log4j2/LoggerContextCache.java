...
final class LoggerContextCache implements Disposable {
        ...
        if (ctx == null) {
          ...
          try {
            ...
            if (e.getCause() instanceof MuleRuntimeException) {
              ...
              throw new MuleRuntimeException(createStaticMessage("Could not init logger context "), e.getCause());
            }
          } finally {
   ...
   */
  protected LoggerContext doGetLoggerContext(final ClassLoader classLoader, final Integer key)
