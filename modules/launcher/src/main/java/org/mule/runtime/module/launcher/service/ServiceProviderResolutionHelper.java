...
public interface ServiceProviderResolutionHelper
{
     ...
     */
    void injectInstance(ServiceProvider serviceProvider, Collection<ServiceDefinition> resolvedServices) throws ServiceResolutionError;
     ...
     * <p/>
     * Only service classes are able to be injected, if a non service class is found then the discovery process must fail
