...
/**
 *  Common logic to create and persist a file containing deployment properties for each
 *  app/domain deployed/redeployed.
 */
public class DeploymentPropertiesUtils
{
     ...
     * the new deployment properties passed by the user as parameter and the deployment 
     * properties persisted in a previous deploy.
    ...
    /**
     * Gets the deployment properties from the deploymentPropertiesPath. The file that
     * contains the properties is deployment.properties.
     * 
    ...
    /**
     * Initialises the directory for the deployment properties in case it does not
     * exist.
     *  
    ...
    private static synchronized void createDeploymentPropertiesDirectory(File deploymentPropertiesDirectory)
    {
        ...
        {
            Message message = CoreMessages.failedToCreate("deployment properties directory "
