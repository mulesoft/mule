...
public class MuleLog4jContextFactoryTestCase extends AbstractMuleTestCase
{
    ...
    public void systemProperties()
    {
        ...
        assertEquals(XmlConfigurationFactory.class.getName(), getProperty(LOG_CONFIGURATION_FACTORY_PROPERTY));
        assertEquals(AsyncLoggerExceptionHandler.class.getName(), getProperty(ASYNC_LOGGER_EXCEPTION_HANDLER_PROPERTY));
    }
    ...
    public void customExceptionHandler()
    {
        ...
        new MuleLog4jContextFactory();
        assertEquals(customHandler, System.getProperty(ASYNC_LOGGER_EXCEPTION_HANDLER_PROPERTY));
    }
