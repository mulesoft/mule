...
public class DirectoryToSystemDeploymentBundle extends AbstractSDBTransformer
{
     ...
     * Serial version
     */
    private static final long serialVersionUID = 348109763671992314L;
    ...
    protected Iterator getEntryIterator(Object src) throws Exception
    {
        ...
        if (src instanceof String)
        {
            ...
            if (!f.exists())
            {
                URL url = ClassUtils.getResource(src.toString(), getClass());
            ...
            throws Exception
    {
        ...
        return new BundleEntry(f.getName(), f.toURL().toString(), f
                .isDirectory());
    }
}
