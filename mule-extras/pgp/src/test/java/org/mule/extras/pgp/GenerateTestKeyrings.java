...
public class GenerateTestKeyrings {
    ...
    public static void generateServerKey() {
        ...
        try {
            ...
            serverPrivateKey.addPrivateKey(privkey, pubkey, 
    ...
    public static void generateClientKey() {
        ...
        try {
            ...
            clientPrivateKey.addPrivateKey(privkey, pubkey, 
                "TestingPassphrase".toCharArray(), sr);
    ...
    public static void writeKeyrings() {
        ...
        try {
            ...
            clientPubRing  = (ExtendedKeyStore)
                ExtendedKeyStore.getInstance("OpenPGP/KeyRing");
            clientPrivRing = (ExtendedKeyStore) 
                ExtendedKeyStore.getInstance("OpenPGP/KeyRing");
            serverPubRing    = (ExtendedKeyStore)
                ExtendedKeyStore.getInstance("OpenPGP/KeyRing");
            serverPrivRing   = (ExtendedKeyStore)
                ExtendedKeyStore.getInstance("OpenPGP/KeyRing");
        ...
        try {
            ...
            out = new FileOutputStream("clientPublic.gpg");  // pkr = public key ring
            clientPubRing.store(out, null);
            out.close();

            out = new FileOutputStream("clientPrivate.gpg");  // skr = secret key ring
