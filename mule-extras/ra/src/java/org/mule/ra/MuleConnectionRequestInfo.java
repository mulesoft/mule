...
public class MuleConnectionRequestInfo implements ConnectionRequestInfo, Cloneable, Serializable
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MuleConnectionRequestInfo)) return false;

        final MuleConnectionRequestInfo muleConnectionRequestInfo = (MuleConnectionRequestInfo) o;

        if (configurationBuilder != null ? !configurationBuilder.equals(muleConnectionRequestInfo.configurationBuilder) : muleConnectionRequestInfo.configurationBuilder != null) return false;
        if (configurations != null ? !configurations.equals(muleConnectionRequestInfo.configurations) : muleConnectionRequestInfo.configurations != null) return false;
        if (password != null ? !password.equals(muleConnectionRequestInfo.password) : muleConnectionRequestInfo.password != null) return false;
        if (username != null ? !username.equals(muleConnectionRequestInfo.username) : muleConnectionRequestInfo.username != null) return false;
